...
int OnInit()
  {
//--- получение хендла индикатора TSI_WPR
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"TSI_WPR",XMA_Method,WPRPeriod,MomPeriod,XLength1,XLength2,XLength3,XPhase);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора TSI_WPR");
      return(INIT_FAILED);
     }
