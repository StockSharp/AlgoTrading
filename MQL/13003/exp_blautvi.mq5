...
input int    StopLoss_=1000;       // Стоп Лосс в пунктах
input int    TakeProfit_=2000;     // Тейк Профит в пунктах
...
//---- получение хендла индикатора BlauTVI
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"BlauTVI",XMA_Method,XLength1,XLength2,XLength3,XPhase,VolumeType);
