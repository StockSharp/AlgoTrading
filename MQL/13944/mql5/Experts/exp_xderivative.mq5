...
//+----------------------------------------------+
//| Входные параметры индикатора XDerivative     |
//+----------------------------------------------+
...
int OnInit()
  {
//---- получение хендла индикатора XDerivative
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"XDerivative",i_slowing,i_price,XMA_Method,XLength,XPhase,0);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора XDerivative");
      return(INIT_FAILED);
     }
