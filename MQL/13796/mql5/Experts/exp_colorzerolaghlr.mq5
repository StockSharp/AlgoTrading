...
//+--------------------------------------------------+
//| Входные параметры для индикатора ColorZerolagHLR |
//+--------------------------------------------------+
...
int OnInit()
  {
//---- получение хендла индикатора ColorZerolagHLR
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"ColorZerolagHLR",
                         smoothing,Factor1,HLR_period1,Factor2,HLR_period2,
                         Factor3,HLR_period3,Factor4,HLR_period4,Factor5,HLR_period5);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print("Не удалось получить хендл индикатора ColorZerolagHLR");
      return(INIT_FAILED);
     }
