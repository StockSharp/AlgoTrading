...
//+-------------------------------------------------+
//| Входные параметры индикатора MomentumCandleSign |
//+-------------------------------------------------+
input ENUM_TIMEFRAMES InpInd_Timeframe=PERIOD_H12; // Таймфрейм индикатора MomentumCandleSign
...
int OnInit()
  {
//---- получение хендла индикатора MomentumCandleSign
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"MomentumCandleSign",Ind_Period);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора MomentumCandleSign");
      return(INIT_FAILED);
     }
