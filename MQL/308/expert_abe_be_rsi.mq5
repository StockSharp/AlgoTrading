...
input int    Signal__PeriodRSI    =11;                  // CBE_BE_RSI(11,5) Period of RSI
input int    Signal__PeriodMA     =5;                   // CBE_BE_RSI(11,5) Period of MA
input double Signal__Weight       =1.0;                 // CBE_BE_RSI(11,5) Weight [0...1.0]
//--- inputs for money
...
//--- Creating filter CBE_BE_RSI
   CBE_BE_RSI *filter0=new CBE_BE_RSI;
   if(filter0==NULL)
     {
      //--- failed
