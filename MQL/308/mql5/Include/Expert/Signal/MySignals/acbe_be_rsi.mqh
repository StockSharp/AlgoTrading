...
//+------------------------------------------------------------------+
class CBE_BE_RSI : public CCandlePattern
  {
protected:
...
//+------------------------------------------------------------------+
//| Constructor CBE_BE_RSI.                                          |
//| INPUT:  no.                                                      |
//| OUTPUT: no.                                                      |
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
void CBE_BE_RSI::CBE_BE_RSI()
  {
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CBE_BE_RSI::ValidationSettings()
  {
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CBE_BE_RSI::InitIndicators(CIndicators *indicators)
  {
//--- check pointer
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CBE_BE_RSI::InitRSI(CIndicators *indicators)
  {
//--- check pointer
   if(indicators==NULL) return(false);
...
int CBE_BE_RSI::LongCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of Bullish Engulfing and RSI<40
...
int CBE_BE_RSI::ShortCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of Bearish Engulfing pattern and RSI>60     
