...
//+------------------------------------------------+
//| Exp_ColorStepXCCX indicator input parameters   |
//+------------------------------------------------+
...
int OnInit()
  {
//---- getting the ColorStepXCCX indicator handle
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"ColorStepXCCX",
                         DSmoothMethod,DPeriod,DPhase,MSmoothMethod,MPeriod,MPhase,IPC,StepSizeFast,StepSizeSlow,0);
   if(InpInd_Handle==INVALID_HANDLE) Print(" Failed to get handle of ColorStepXCCX indicator");
...
//---- Initialization of variables of the start of data calculation
   CXMA XMAD;
   min_rates_total=XMAD.GetStartBars(DSmoothMethod,DPeriod,DPhase);
   min_rates_total+=XMAD.GetStartBars(MSmoothMethod,MPeriod,MPhase);
