...
input int    Signal__PeriodCCI    =11;                 // CH_HM_CCI(11,5) Period of CCI
input int    Signal__PeriodMA     =5;                  // CH_HM_CCI(11,5) Period of MA
input double Signal__Weight       =1.0;                // CH_HM_CCI(11,5) Weight [0...1.0]
//--- inputs for money
...
//--- Creating filter CH_HM_CCI
   CH_HM_CCI *filter0=new CH_HM_CCI;
   if(filter0==NULL)
     {
      //--- failed
