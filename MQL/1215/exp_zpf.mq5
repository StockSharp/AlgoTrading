...
//+----------------------------------------------+
//| ZPF indicator input parameters               |
//+----------------------------------------------+
...
int OnInit()
  {
//---- getting handle of the ZPF indicator
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"ZPF",XMA_Method,XLength,XPhase,IPC,VolumeType,0);
   if(InpInd_Handle==INVALID_HANDLE) Print(" Failed to get handle of ZPF indicator");
...
//---- Initialization of variables of the start of data calculation
   CXMA XMA;
   min_rates_total=XMA.GetStartBars(XMA_Method,int(2*XLength),XPhase);
