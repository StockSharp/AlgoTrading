...
//+----------------------------------------------+
input ENUM_TIMEFRAMES InpInd_Timeframe=PERIOD_H4; ///time frame of the VortexIndicator
...
int OnInit()
  {
//---- getting the VortexIndicator indicator handle
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"VortexIndicator",VI_Length,0);
   if(InpInd_Handle==INVALID_HANDLE) Print(" Failed to get handle of VortexIndicator indicator");
