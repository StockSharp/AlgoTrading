...
input double ExtraHighLevel=+0.3;                     // уровень максимального тренда вверх
input double HighLevel=+0.1;                          // уровень сильного тренда вверх
input double LowLevel=-0.1;                           // уровень слабого тренда вниз
input double ExtraLowLevel=-0.3;                      // уровень максимального тренда вниз
//+----------------------------------------------+
