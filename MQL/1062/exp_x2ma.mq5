...
//---- getting handle of the X2MA indicator
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"X2MA",MA_Method1,Length1,Phase1,MA_Method2,Length2,Phase2,IPC,0,0);
   if(InpInd_Handle==INVALID_HANDLE) Print(" Failed to get handle of X2MA indicator");
...
//---- Initialization of variables of the start of data calculation
   int StartBars1=XMA.GetStartBars(MA_Method1, Length1, Phase1);
   int StartBars2=XMA.GetStartBars(MA_Method2, Length2, Phase2);
   min_rates_total=int(StartBars1+StartBars2+3+SignalBar);
//----
   return(0);
  }
//+------------------------------------------------------------------+
