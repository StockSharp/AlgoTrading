...
int OnInit()
  {
//--- получение хендла индикатора FisherCyberCycle
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"FisherCyberCycle",Alpha,Length,0);
   if(InpInd_Handle==INVALID_HANDLE) Print(" Не удалось получить хендл индикатора FisherCyberCycle");
//--- инициализация переменной для хранения периода графика в секундах  
   TimeShiftSec=PeriodSeconds(InpInd_Timeframe);
//--- инициализация переменных начала отсчёта данных
   min_rates_total=int(Length+3);
