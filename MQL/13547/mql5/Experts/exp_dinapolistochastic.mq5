...
int OnInit()
  {
//---- получение хендла индикатора DiNapoliStochastic
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"DiNapoliStochastic",FastK,SlowK,SlowD,0);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора DiNapoliStochastic");
      return(INIT_FAILED);
     }
