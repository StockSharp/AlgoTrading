//+------------------------------------------------------------------+
//|                                  Exp_Elliott_Wave_Oscillator.mq5 |
...
int OnInit()
  {
//---- получение хендла индикатора Elliott_Wave_Oscillator
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"Elliott_Wave_Oscillator",MA_Method1,Length1,Phase1,IPC1,MA_Method2,Length2,Phase2,IPC2,0);
