//+------------------------------------------------------------------+
//|                                 Exp_Volume_Weighted_MACandle.mq5 |
...
//+---------------------------------------------------------+
//| Входные параметры для индикатора Volume_Weighted_MACandle |
//+---------------------------------------------------------+
...
int OnInit()
  {
//---- получение хендла индикатора Volume_Weighted_MACandle
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"Volume_Weighted_MACandle",Length,VolumeType);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print("Не удалось получить хендл индикатора Volume_Weighted_MACandle");
      return(INIT_FAILED);
     }
