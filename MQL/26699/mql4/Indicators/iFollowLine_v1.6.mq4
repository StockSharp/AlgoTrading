...
#property description "iFollowLine"
#property strict
//===================================================================================================================================================//
...
//-----------------------------------------------------------------------------------
   for(i=Limit-1; i>=0; i--)
     {
      BB_Upper=iBands(NULL,0,BBperiod,BBdeviations,0,PRICE_CLOSE,MODE_UPPER,i+1+ShiftBars);
      BB_Lower=iBands(NULL,0,BBperiod,BBdeviations,0,PRICE_CLOSE,MODE_LOWER,i+1+ShiftBars);
      //-----------------------------------------------------------------------------------
      ...
      if(BB_Signal>0)
        {
         if(UseATRfilter==true) TrendLine[i]=NormalizeDouble(low[i+ShiftBars]-iATR(NULL,0,ATRperiod,i+ShiftBars),Digits);
         if(UseATRfilter==false) TrendLine[i]=NormalizeDouble(low[i+ShiftBars],Digits);
         if(TrendLine[i]<TrendLine[i+1]) TrendLine[i]=TrendLine[i+1];
        }
      //---
      if(BB_Signal<0)
        {
         if(UseATRfilter==true) TrendLine[i]=NormalizeDouble(high[i+ShiftBars]+iATR(NULL,0,ATRperiod,i+ShiftBars),Digits);
         if(UseATRfilter==false) TrendLine[i]=NormalizeDouble(high[i+ShiftBars],Digits);
         if(TrendLine[i]>TrendLine[i+1]) TrendLine[i]=TrendLine[i+1];
        }
      //---
     }
   ...
   for(i=Limit-2; i>=0; i--)
     {
      ...
      if(TypeOfArrows>1)
        {
         MA_High=iMA(NULL,0,MAperiod,0,MODE_SMA,PRICE_HIGH,i+ShiftBars);
         MA_Open=iMA(NULL,0,MAperiod,0,MODE_SMA,PRICE_OPEN,i+ShiftBars);
         MA_Close=iMA(NULL,0,MAperiod,0,MODE_SMA,PRICE_CLOSE,i+ShiftBars);
         MA_Low=iMA(NULL,0,MAperiod,0,MODE_SMA,PRICE_LOW,i+ShiftBars);
         MA_Median=iMA(NULL,0,MAperiod,0,MODE_SMA,PRICE_MEDIAN,i+ShiftBars);
         //-------------------------------------------------
