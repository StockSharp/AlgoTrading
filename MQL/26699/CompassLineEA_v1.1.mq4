...
enum Rev {Not_Close_In_Signal, Close_In_Booth_Indicators, Close_In_Indicator_1, Close_In_Indicator_2};
//====================================================================================================================================================//
extern string IndicatorsSets_1  = "==== Set Indicator 1 ====";
extern string IndicatorName_1   ="iFollowLine_v1.6";
extern int    BarsCount_1       = 10;
extern int    BBperiod_1        = 21;
extern double BBdeviations_1    = 1;
extern int    MAperiod_1        = 21;
extern int    ATRperiod_1       = 5;
extern bool   UseATRfilter_1    = false;
extern bool   AlertON_1         = false;
extern Arrows TypeOfArrows_1    = Simple_Arrows;
extern int    IndicatorsShift_1 = 1;
extern int    ShiftBars_1       = 0;
extern string IndicatorsSets_2  = "==== Set Indicator 2 ====";
extern string IndicatorName_2   ="iCompass_v1.1";
extern int    BarsCount_2       = 10;
extern int    MAperiod_2        = 30;
extern int    ShiftBars_2       = 0;
extern int    IndicatorsShift_2 = 1;
extern string SetCloseOrders    = "==== Set Close Orders ====";
extern Rev    CloseInSignal     = Not_Close_In_Signal;
...
extern string CommentsOrders    = "CompassLineEA";
//====================================================================================================================================================//
   ...
   if((CheckSpread==true) && (TimeToTrade==true) && ((SumOrders<MaxOrders) || (MaxOrders==0)))
     {
      GetSignals();
      //---Check for buy
      if((OpenBuy==true) && (iBars(NameOfSymbol,0)!=BarOpenBuy) && (BuyOrders==0))
        {
         BarOpenBuy=iBars(NameOfSymbol,0);
         OpenPosition(OP_BUY);
        }
      //---Check for sell
      if((OpenSell==true) && (iBars(NameOfSymbol,0)!=BarOpenSell) && (SellOrders==0))
        {
...
//------------------------------------------------------
   if(iTime(NULL,0,0)!=LastTimeBar)
     {
      TrendUP=iCustom(NULL,0,IndicatorName_1,BarsCount_1,BBperiod_1,BBdeviations_1,MAperiod_1,ATRperiod_1,UseATRfilter_1,AlertON_1,TypeOfArrows_1,ShiftBars_1,2,IndicatorsShift_1);
      TrendDN=iCustom(NULL,0,IndicatorName_1,BarsCount_1,BBperiod_1,BBdeviations_1,MAperiod_1,ATRperiod_1,UseATRfilter_1,AlertON_1,TypeOfArrows_1,ShiftBars_1,3,IndicatorsShift_1);
      LineUP=iCustom(NULL,0,IndicatorName_2,BarsCount_2,MAperiod_2,ShiftBars_2,0,IndicatorsShift_2);
      LineDN=iCustom(NULL,0,IndicatorName_2,BarsCount_2,MAperiod_2,ShiftBars_2,1,IndicatorsShift_2);
      //---
      //Print(TrendUP," || ",TrendDN," || ",LineUP," || ",LineDN);
      //------------------------------------------------------
      //Signals open orders
      if((TrendUP!=EMPTY_VALUE)&&(LineUP!=EMPTY_VALUE))
         OpenBuy=true;
      if((TrendDN!=EMPTY_VALUE)&&(LineDN!=EMPTY_VALUE))
         OpenSell=true;
      //------------------------------------------------------
      //Signals close orders
      if(CloseInSignal>0)
        {
         switch(CloseInSignal)
           {
            case 1:
               ...
               break;
            case 2:
               if((BuyOrders>0)&&(TrendDN!=EMPTY_VALUE))
                  CloseBuy=true;
               if((SellOrders>0)&&(TrendUP!=EMPTY_VALUE))
                  CloseSell=true;
               break;
            case 3:
               if((BuyOrders>0)&&(LineDN!=EMPTY_VALUE))
                  CloseBuy=true;
               if((SellOrders>0)&&(LineUP!=EMPTY_VALUE))
                  CloseSell=true;
               break;
           }
        }
