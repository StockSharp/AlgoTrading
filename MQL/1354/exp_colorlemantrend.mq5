...
//+---------------------------------------------------+
//| Exp_ColorLeManTrend indicator input parameters    |
//+---------------------------------------------------+
...
int OnInit()
  {
//---- getting the ColorLeManTrend indicator handle
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"ColorLeManTrend",Min,Midle,Max,PeriodEMA);
   if(InpInd_Handle==INVALID_HANDLE) Print(" Failed to get handle of ColorLeManTrend indicator");

//---- initialization of a variable for storing a chart period in seconds  
   TimeShiftSec=PeriodSeconds(InpInd_Timeframe);

//---- Initialization of variables of the start of data calculation
   min_rates_total=MathMax(MathMax(Min,Midle),Max)+PeriodEMA; 
