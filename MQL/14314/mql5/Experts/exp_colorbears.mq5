...
//+----------------------------------------------+
//| Входные параметры индикатора ColorBears      |
//+----------------------------------------------+
...
int OnInit()
  {
//---- получение хендла индикатора ColorBears
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"ColorBears",MA_Method1,Length1,Phase1,MA_Method2,Length2,Phase2,IPC,0);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора ColorBears");
      return(INIT_FAILED);
     }
