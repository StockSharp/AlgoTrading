...
//+------------------------------------------------------------------+
class CBE_BE_Stoch : public CCandlePattern
  {
protected:
...
//+------------------------------------------------------------------+
//| CBE_BE_Stoch class constructor.                                  |
//| INPUT:  no.                                                      |
//| OUTPUT: no.                                                      |
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
void CBE_BE_Stoch::CBE_BE_Stoch()
  {
//--- set default inputs
   m_periodK    =7;
   m_periodD    =11;
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CBE_BE_Stoch::ValidationSettings()
  {
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CBE_BE_Stoch::InitIndicators(CIndicators *indicators)
  {
//--- check
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CBE_BE_Stoch::InitStoch(CIndicators *indicators)
  {
...
int CBE_BE_Stoch::LongCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of Bullish Engulfing pattern and
...
int CBE_BE_Stoch::ShortCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of three Bearish Engulfing pattern and
//--- check signal line of stochastic indicator
