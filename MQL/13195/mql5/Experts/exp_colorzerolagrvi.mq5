...
//+--------------------------------------------------+
//| Входные параметры для индикатора ColorZerolagRVI |
//+--------------------------------------------------+
...
int OnInit()
  {
//---- получение хендла индикатора ColorZerolagRVI
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"ColorZerolagRVI",
                         smoothing,Factor1,RVI_period1,Factor2,RVI_period2,
                         Factor3,RVI_period3,Factor4,RVI_period4,Factor5,RVI_period5);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print("Не удалось получить хендл индикатора ColorZerolagRVI");
      return(INIT_FAILED);
     }
