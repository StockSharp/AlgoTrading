...
int OnInit()
  {
//---- получение хендла индикатора FRASMAv2
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"FRASMAv2",e_period,normal_speed,IPC,0,0);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора FRASMAv2");
      return(INIT_FAILED);
     }
...
//---- Инициализация переменных начала отсчёта данных
   int g_period_minus_1=int(e_period)-1;
