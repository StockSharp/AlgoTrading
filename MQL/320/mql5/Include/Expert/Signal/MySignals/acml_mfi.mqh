...
//| Class=CML_MFI                                                    |
//| Page=                                                            |
//| Parameter=PeriodMFI,int,12,Period of MFI                         |
//| Parameter=PeriodMA,int,4, Period of MA                           |
//+------------------------------------------------------------------+
...
//+------------------------------------------------------------------+
class CML_MFI : public CCandlePattern
  {
protected:
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CML_MFI::ValidationSettings()
  {
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CML_MFI::InitIndicators(CIndicators *indicators)
  {
//--- check pointer
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CML_MFI::InitMFI(CIndicators *indicators)
  {
//--- check pointer
   if(indicators==NULL) return(false);
...
int CML_MFI::LongCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of Bullish Meeting Lines and MFI<40
...
int CML_MFI::ShortCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of Bearish Meeting Lines and MFI>60
