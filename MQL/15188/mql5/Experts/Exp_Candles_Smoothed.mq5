...
//+------------------------------------------------+
//| Входные параметры индикатора Candles_Smoothed  |
//+------------------------------------------------+
...
int OnInit()
  {
//---- получение хендла индикатора Candles_Smoothed
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"Candles_Smoothed",MA_SMethod,MA_Length,MA_Phase);
   if(InpInd_Handle==INVALID_HANDLE) Print(" Не удалось получить хендл индикатора Candles_Smoothed");
