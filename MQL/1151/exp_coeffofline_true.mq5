...
//+----------------------------------------------+
//| CoeffofLine_true indicator input parameters  |
//+----------------------------------------------+
...
//---- getting handle of the CoeffofLine_true indicator
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"CoeffofLine_true",SMMAPeriod);
   if(InpInd_Handle==INVALID_HANDLE) Print(" Failed to get handle of CoeffofLine_true indicator");

//---- initialization of a variable for storing a chart period in seconds  
   TimeShiftSec=PeriodSeconds(InpInd_Timeframe);

//---- Initialization of variables of the start of data calculation
   min_rates_total=int(SMMAPeriod+1+2+SignalBar);
//----
   return(0);
  }
//+------------------------------------------------------------------+
