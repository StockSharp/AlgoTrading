...
int OnInit()
  {
//--- получение хендла индикатора TSI_CCI
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"TSI_CCI",XMA_Method,CCIPeriod,CCIPrice,MomPeriod,XLength1,XLength2,XLength3,XPhase);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора TSI_CCI");
      return(INIT_FAILED);
     }
