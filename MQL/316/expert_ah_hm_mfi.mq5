...
input int    Signal__PeriodMFI    =47;                 // CH_HM_MFI(47,5) Period of MFI
input int    Signal__PeriodMA     =5;                  // CH_HM_MFI(47,5) Period of MA
input double Signal__Weight       =1.0;                // CH_HM_MFI(47,5) Weight [0...1.0]
//--- inputs for money
...
//--- Creating filter CH_HM_MFI
   CH_HM_MFI *filter0=new CH_HM_MFI;
   if(filter0==NULL)
     {
      //--- failed
