...
//+----------------------------------------------+
//| Входные параметры индикатора ColorBulls      |
//+----------------------------------------------+
...
int OnInit()
  {
//---- получение хендла индикатора ColorBulls
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"ColorBulls",MA_Method1,Length1,Phase1,MA_Method2,Length2,Phase2,IPC,0);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора ColorBulls");
      return(INIT_FAILED);
     }
