...
input int            Signal__StochPeriodK   =12;                    // CMS_ES_Stoch(12,8,29,...) 
input int            Signal__StochPeriodD   =8;                     // CMS_ES_Stoch(12,8,29,...) 
input int            Signal__StochPeriodSlow=29;                    // CMS_ES_Stoch(12,8,29,...) 
input ENUM_STO_PRICE Signal__StochApplied   =STO_LOWHIGH;           // CMS_ES_Stoch(12,8,29,...) 
input int            Signal__MAPeriod       =4;                     // CMS_ES_Stoch(12,8,29,...) 
input double         Signal__Weight         =1.0;                   // CMS_ES_Stoch(12,8,29,...) Weight [0...1.0]
//--- inputs for money
...
//--- Creating filter CMS_ES_Stoch
   CMS_ES_Stoch *filter0=new CMS_ES_Stoch;
   if(filter0==NULL)
     {
      //--- failed
