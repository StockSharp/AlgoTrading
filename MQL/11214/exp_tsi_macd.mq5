...
//--- получение хендла индикатора TSI_MACD
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"TSI_MACD",XMA_Method,XFast,XSlow,MomPeriod,XLength1,XLength2,XLength3,XPhase,IPC);
...
//--- Инициализация переменных начала отсчёта данных
   min_rates_total=int(MathMax(GetStartBars(XMA_Method,XFast,XPhase),GetStartBars(XMA_Method,XSlow,XPhase)));
