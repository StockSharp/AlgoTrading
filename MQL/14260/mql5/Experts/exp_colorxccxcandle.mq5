...
//+-------------------------------------------------+
//| Входные параметры индикатора ColorXCCXCandle    |
//+-------------------------------------------------+
input ENUM_TIMEFRAMES InpInd_Timeframe=PERIOD_H4; // Таймфрейм индикатора ColorXCCXCandle
...
int OnInit()
  {
//---- получение хендла индикатора ColorXCCXCandle
   ...
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора ColorXCCXCandle");
      return(INIT_FAILED);
     }
