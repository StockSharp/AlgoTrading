...
//+----------------------------------------------+
//| TrendEnvelopes indicator input parameters    |
//+----------------------------------------------+
...
input double   Deviation=0.2;       // Deviation
...
int OnInit()
  {
//---- getting handle of the TrendEnvelopes indicator
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"TrendEnvelopes",
                         MA_Period,MA_Method,Applied_Price,Deviation,ATRPeriod,ATRSensitivity,0);
   if(InpInd_Handle==INVALID_HANDLE) Print(" Failed to get handle of TrendEnvelopes indicator");
   ...
   if(!SignalBar || NB.IsNewBar(Symbol(),InpInd_Timeframe) || Recount) // checking for a new bar
     {
      ...
      //---- Search of the last trade direction
