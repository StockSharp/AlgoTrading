...
int OnInit()
  {
//---- получение хендла индикатора i-SpectrAnalysis_WPR
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"i-SpectrAnalysis_WPR",WPRPeriod,N,SS,0);
   if(InpInd_Handle==INVALID_HANDLE)  
     {
      Print(" Не удалось получить хендл индикатора i-SpectrAnalysis_WPR");
      return(INIT_FAILED);
     }
