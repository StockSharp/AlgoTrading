...
//+--------------------------------------------------+
//| Входные параметры для индикатора ColorZerolagTriX|
//+--------------------------------------------------+
...
int OnInit()
  {
//---- получение хендла индикатора ColorZerolagTriX
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"ColorZerolagTriX",
                         smoothing,IPC,Factor1,TriX_period1,Factor2,TriX_period2,
                         Factor3,TriX_period3,Factor4,TriX_period4,Factor5,TriX_period5);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print("Не удалось получить хендл индикатора ColorZerolagTriX");
      return(INIT_FAILED);
     }
