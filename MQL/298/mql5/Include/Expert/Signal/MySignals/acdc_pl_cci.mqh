...
//+------------------------------------------------------------------+
class CDC_PL_CCI : public CCandlePattern
  {
protected:
...
//+------------------------------------------------------------------+
//| Constructor CDC_PL_CCI.                                          |
//| INPUT:  no.                                                      |
//| OUTPUT: no.                                                      |
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
void CDC_PL_CCI::CDC_PL_CCI()
  {
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CDC_PL_CCI::ValidationSettings()
  {
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CDC_PL_CCI::InitIndicators(CIndicators *indicators)
  {
//--- check pointer
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CDC_PL_CCI::InitCCI(CIndicators *indicators)
  {
//--- check pointer
   if(indicators==NULL) return(false);
...
int CDC_PL_CCI::LongCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of Piercing Line and CCI<-50
...
int CDC_PL_CCI::ShortCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of Dark Cloud Cover pattern and CCI>50
