...
//+----------------------------------------------+
//| Входные параметры индикатора CoppockHist     |
//+----------------------------------------------+
...
int OnInit()
  {
//---- получение хендла индикатора CoppockHist
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"CoppockHist",ROC1Period,ROC2Period,SmoothPeriod,MA_Method_,AppliedPrice);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора CoppockHist");
      return(INIT_FAILED);
     }
