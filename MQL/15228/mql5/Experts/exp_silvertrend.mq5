...
//+-------------------------------------------------+
//| Входные параметры индикатора SilverTrend_Signal |
//+-------------------------------------------------+
input ENUM_TIMEFRAMES InpInd_Timeframe=PERIOD_H1; //таймфрейм индикатора SilverTrend_Signal
input int SSP=9;                                  //период индикатора
...
//---- получение хендла индикатора SilverTrend_Signal
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"SilverTrend_Signal",SSP,RISK,0);
...
//---- инициализация переменных начала отсчета данных
   min_rates_total=int(SSP+1+SignalBar);
