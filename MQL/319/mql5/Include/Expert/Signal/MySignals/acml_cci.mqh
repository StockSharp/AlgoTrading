...
//| Class=CML_CCI                                                    |
//| Page=                                                            |
//| Parameter=PeriodCCI,int,18,Period of CCI                         |
...
//+------------------------------------------------------------------+
class CML_CCI : public CCandlePattern
  {
protected:
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CML_CCI::ValidationSettings()
  {
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CML_CCI::InitIndicators(CIndicators *indicators)
  {
//--- check pointer
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CML_CCI::InitCCI(CIndicators *indicators)
  {
//--- check pointer
   if(indicators==NULL) return(false);
...
int CML_CCI::LongCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of Bullish Meeting Lines and CCI<-50
...
int CML_CCI::ShortCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of Bearish Meeting Lines and CCI>50
