...
input int    Signal__PeriodCCI    =18;               // CML_CCI(18,3) Period of CCI
input int    Signal__PeriodMA     =3;                // CML_CCI(18,3) Period of MA
input double Signal__Weight       =1.0;              // CML_CCI(18,3) Weight [0...1.0]
//--- inputs for money
...
//--- Creating filter CML_CCI
   CML_CCI *filter0=new CML_CCI;
   if(filter0==NULL)
     {
      //--- failed
