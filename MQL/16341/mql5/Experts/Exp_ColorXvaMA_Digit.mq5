...
int OnInit()
  {
//---- получение хендла индикатора ColorXvaMA_Digit
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"ColorXvaMA_Digit",SirName,XMA_Method1,XLength1,XPhase1,XMA_Method2,XLength2,XPhase2,IPC,0,0,Digit,true,clrGray);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора ColorXvaMA_Digit");
      return(INIT_FAILED);
     }
...
//---- Инициализация переменных начала отсчёта данных
   ...
   min_rates_total+=GetStartBars(XMA_Method2,XLength2,XPhase2);
