...
input int            Signal__StochPeriodK   =15;                   // CH_HM_Stoch(15,49,25,...) 
input int            Signal__StochPeriodD   =49;                   // CH_HM_Stoch(15,49,25,...) 
input int            Signal__StochPeriodSlow=25;                   // CH_HM_Stoch(15,49,25,...) 
input ENUM_STO_PRICE Signal__StochApplied   =STO_LOWHIGH;          // CH_HM_Stoch(15,49,25,...) 
input int            Signal__MAPeriod       =15;                   // CH_HM_Stoch(15,49,25,...) 
input double         Signal__Weight         =1.0;                  // CH_HM_Stoch(15,49,25,...) Weight [0...1.0]
//--- inputs for money
...
//--- Creating filter CH_HM_Stoch
   CH_HM_Stoch *filter0=new CH_HM_Stoch;
   if(filter0==NULL)
     {
      //--- failed
