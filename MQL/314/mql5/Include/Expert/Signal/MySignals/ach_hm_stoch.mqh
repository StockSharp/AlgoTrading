...
//| Title=Signals based on Hammer/Hanging Man confirmed by Stochastic|
//| Type=SignalAdvanced                                              |
//| Name=CH_HM_Stoch                                                 |
//| Class=CH_HM_Stoch                                                |
//| Page=                                                            |
...
//+------------------------------------------------------------------+
class CH_HM_Stoch : public CCandlePattern
  {
protected:
...
//+------------------------------------------------------------------+
//| CH_HM_Stoch class constructor.                                  |
//| INPUT:  no.                                                      |
//| OUTPUT: no.                                                      |
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
void CH_HM_Stoch::CH_HM_Stoch()
  {
//--- set default inputs
   m_periodK    =7;
   m_periodD    =11;
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CH_HM_Stoch::ValidationSettings()
  {
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CH_HM_Stoch::InitIndicators(CIndicators *indicators)
  {
//--- check
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CH_HM_Stoch::InitStoch(CIndicators *indicators)
  {
...
int CH_HM_Stoch::LongCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of Hammer pattern and
...
int CH_HM_Stoch::ShortCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of Hanging Man pattern and
