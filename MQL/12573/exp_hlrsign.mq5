...
//+----------------------------------------------+
//| Входные параметры индикатора HLRSign         |
//+----------------------------------------------+
input ENUM_TIMEFRAMES InpInd_Timeframe=PERIOD_H1; // Таймфрейм индикатора HLRSign
...
int OnInit()
  {
//--- получение хендла индикатора HLRSign
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"HLRSign",Mode,HLR_Range,HLR_UpLevel,HLR_DnLevel,0);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора HLRSign");
      return(INIT_FAILED);
     }
