...
int OnInit()
  {
//---- получение хендла индикатора CCI_Woodies
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"CCI_Woodies",FastPeriod,FastPrice,SlowPeriod,SlowPrice,0);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print("Не удалось получить хендл индикатора CCI_Woodies");
      return(INIT_FAILED);
     }
