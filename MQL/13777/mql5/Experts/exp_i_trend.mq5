...
int OnInit()
  {
//---- получение хендла индикатора i_Trend
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"i_Trend",Price_Type,MAPeriod,MAType,MAPrice,BBPeriod,Deviation,BBPrice,BBMode);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора i_Trend");
      return(INIT_FAILED);
     }
