...
//+----------------------------------------------+
//| Входные параметры индикатора wlxBW5Zone      |
//+----------------------------------------------+
input ENUM_TIMEFRAMES InpInd_Timeframe=PERIOD_H4; //таймфрейм индикатора wlxBW5Zone
...
int OnInit()
  {
//---- получение хендла индикатора wlxBW5Zone
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"wlxBW5Zone",Dir);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора wlxBW5Zone");
      return(INIT_FAILED);
     }
