...
input int    Signal__PeriodMFI    =49;                  // CMS_ES_MFI(49,5) Period of MFI
input int    Signal__PeriodMA     =5;                   // CMS_ES_MFI(49,5) Period of MA
input double Signal__Weight       =1.0;                 // CMS_ES_MFI(49,5) Weight [0...1.0]
//--- inputs for money
...
//--- Creating filter CMS_ES_MFI
   CMS_ES_MFI *filter0=new CMS_ES_MFI;
   if(filter0==NULL)
     {
      //--- failed
