...
//+----------------------------------------------+
//| Входные параметры индикатора FineTuningMA    |
//+----------------------------------------------+
...
int OnInit()
  {
//---- получение хендла индикатора FineTuningMA
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"FineTuningMA",FTMA,rank1,rank2,rank3,shift1,shift2,shift3,IPC,0,0);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора FineTuningMA");
      return(INIT_FAILED);
     }
