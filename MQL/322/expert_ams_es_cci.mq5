...
input int    Signal__PeriodCCI    =25;                  // CMS_ES_CCI(25,5) Period of CCI
input int    Signal__PeriodMA     =5;                   // CMS_ES_CCI(25,5) Period of MA
input double Signal__Weight       =1.0;                 // CMS_ES_CCI(25,5) Weight [0...1.0]
//--- inputs for money
...
//--- Creating filter CMS_ES_CCI
   CMS_ES_CCI *filter0=new CMS_ES_CCI;
   if(filter0==NULL)
     {
      //--- failed
