...
//| Title=Signals based on Bullish Engulfing/Bearish Engulfing       |
//| confirmed by CCI                                                 |
//| Type=SignalAdvanced                                              |
//| Name=CBE_BE_CCI                                                  |
//| Class=CBE_BE_CCI                                                 |
//| Page=                                                            |
//| Parameter=PeriodCCI,int,49,Period of CCI                         |
...
//+------------------------------------------------------------------+
class CBE_BE_CCI : public CCandlePattern
  {
protected:
...
//+------------------------------------------------------------------+
//| Constructor CBE_BE_CCI.                                          |
//| INPUT:  no.                                                      |
//| OUTPUT: no.                                                      |
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
void CBE_BE_CCI::CBE_BE_CCI()
  {
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CBE_BE_CCI::ValidationSettings()
  {
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CBE_BE_CCI::InitIndicators(CIndicators *indicators)
  {
//--- check pointer
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CBE_BE_CCI::InitCCI(CIndicators *indicators)
  {
//--- check pointer
   if(indicators==NULL) return(false);
...
int CBE_BE_CCI::LongCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of Bullish Engulfing and CCI<-50
...
int CBE_BE_CCI::ShortCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of Bearish Engulfing pattern and CCI>50
