...
//+-------------------------------------------------+
//| Входные параметры индикатора Fisher_org_v1_Sign |
//+-------------------------------------------------+
input ENUM_TIMEFRAMES InpInd_Timeframe=PERIOD_H4; // таймфрейм индикатора Fisher_org_v1_Sign
uint ATR_Period=14;
...
int OnInit()
  {
//---- получение хендла индикатора Fisher_org_v1_Sign
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"Fisher_org_v1_Sign",ATR_Period,Length,IPC,UpLevel,DnLevel,0);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора Fisher_org_v1_Sign");
      return(INIT_FAILED);
     }
...
//---- инициализация переменных начала отсчёта данных
   min_rates_total=int(MathMax(Length+1,ATR_Period))+1;
