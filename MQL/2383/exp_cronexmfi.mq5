...
int OnInit()
  {
//--- получение хендла индикатора CronexMFI
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"CronexMFI",MFIPeriod,XMA_Method,FastPeriod,SlowPeriod,XPhase,VolumeType);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора CronexMFI");
      return(INIT_FAILED);
     }
