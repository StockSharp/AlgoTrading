...
//+----------------------------------------------+
//| AML indicator input parameters               |
//+----------------------------------------------+
...
int OnInit()
  {
//---- getting the ColorAML indicator handle
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"ColorAML",Fractal,Lag,0);
   if(InpInd_Handle==INVALID_HANDLE) Print(" Failed to get handle of ColorAML indicator");
