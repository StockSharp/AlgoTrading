...
extern double TradesPerStop = 3;
extern double MinMarginLevel = 200;  
...
extern int OpenProfitTrades = 6;
extern int MaxBasketTrades = 1;
extern int MaxOverloadTrades = 3;
extern int QueryHistory = 7; 
extern string REWARD = ".............................................................................................................";
extern double TradeSpace = 0.8;
extern double MinProfit = 0.3; 
extern double BasketProfit = 0.5;
extern double OpenProfit = 0.7;
...
double slippage, marginRequirement, lotSize, overLoadLotSize, totalHistoryProfit, totalHistoryLoss, maxBasketDrawDown, totalProfit, totalLoss, symbolHistory,
...
void preparePositions() {
   ...
   sellLots = 0;
   overLoad = false;
   bool overLoadPositions = true;
   bool overLoadBackup = true;
   for( int i = 0 ; i < OrdersTotal() ; i++ ) {
      if( OrderSelect( i, SELECT_BY_POS, MODE_TRADES ) == false ) break; 
      ...
      if( OrderSymbol() == Symbol() && OrderStopLoss() == 0 ) {
         ...
         if( OrderProfit() < 0 ) overLoadPositions = false;
          
      }
   } 
   if( totalTrades == 0 ) maxBasketDrawDown = 0;
   if( maxBasketDrawDown > totalLoss ) maxBasketDrawDown = totalLoss;
   if( !nearLongPosition && !nearShortPosition && overLoadPositions ) overLoad = true; 
...
Print("load up");
   if( AccountFreeMarginCheck( Symbol(), OP_SELL, lotSize ) <= 0 || GetLastError() == 134 ) return; 
   OrderSend( Symbol(), OP_SELL, lotSize, Bid, slippage, 0, 0, "loadup" + DoubleToStr( basketNumber, 0 ), MAGIC ) ;               
}
...
int start() { 
   ...
   if( CloseAll ) closeAll() ;
      ...
      else if( ( ContinueTrading || ( !ContinueTrading && totalTrades > 0 ) && totalTrades >= MaxBasketTrades ) && overLoad ) loadUp();
      managePositions() ;
   }
   return( 0 ) ;
} 
