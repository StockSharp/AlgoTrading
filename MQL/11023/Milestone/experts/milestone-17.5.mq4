...
extern int NewsReleaseSeconds = 1800;
extern int LeadCalendarSeconds = 1440;  
extern int TrailCalendarSeconds = 3600; 
...
extern int QueryHistory = 24;  
extern string PROFIT = ".............................................................................................................";
extern double BasketProfit = 3;
extern double OpenProfit = 0.15;  
extern double MinProfit =  0.035;
extern double SafeProfit =  0.02;
extern string STOP = ".............................................................................................................";
...
extern double BackupMargin = 0.07;
...
void openPosition(){    
   if( ( EnableCalendar && ( ( ffCalenadarEventTime1 > LeadCalendarSeconds && ObjectDescription( "milestoneType1" ) == "until " && ffCalenadarEventTime1 > 0 ) ) 
   && ( ffCalenadarEventTime1 > TrailCalendarSeconds && ObjectDescription( "milestoneType1" ) == "since " && ffCalenadarEventTime1 > 0 ) ) || !EnableCalendar ){
...
void newsSystem(){
   if( ( EnableCalendar && ( ( ffCalenadarEventTime1 < NewsReleaseSeconds && ObjectDescription( "milestoneType1" ) == "since " && ffCalenadarEventTime1 > 0 ) ) ) 
   || ( !EnableCalendar &&  Hour() >= NewsStartHour && Hour() < NewsEndHour ) ){
...
void managePositions(){ 
   ...
   else if( totalTrades > 0 && totalProfit + totalLoss > 0 && ( ( EnableCalendar && ( ffCalenadarEventTime1 < LeadCalendarSeconds && ObjectDescription( "milestoneType1" ) == "until " && ffCalenadarEventTime1 > 0 ) || !EnableCalendar ) ) ) closeAll();
   else { 
      for( int i = OrdersTotal() - 1; i >= 0; i-- ) {
         if( OrderSelect( i, SELECT_BY_POS, MODE_TRADES ) == false ) break;  
         if( OrderSymbol() == Symbol()  ) {  
...
void longStop(){
   if( EnableStop && totalHistoryProfit > StopGrowth * AccountBalance() && ( totalProfit + totalLoss ) < 0 && MathAbs( totalProfit + totalLoss ) > RelativeStop * totalHistoryProfit ){
      closeAll(); 
   }  
}
...
int start() { 
   ...
   if( CloseAll ) closeAll() ;
      ...
      if( dailyGrowth / AccountBalance() < DailyGrowth &&  TimeCurrent() - lastTradeTime > SleepSeconds && ( marginLevel == 0 || marginLevel > MinMarginLevel ) ){  
         ...
         else if( EnableCalendar && ffCalenadarEventTime1 < NewsReleaseSeconds ) newsSystem();
      }
      managePositions() ; 
      longStop();
   }
