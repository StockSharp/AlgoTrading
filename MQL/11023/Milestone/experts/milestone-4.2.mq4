...
extern double BasketProfit = 7.5;
extern double OpenProfit = 5.5; 
extern double MinProfit = 3.5;    
extern string RISK = ".............................................................................................................";
extern bool AccumulateMiles = true;
extern double MileGrowth = 1.5;
extern double AccountLimit = 300;
extern double AccountReserve = 200;
extern int MaxStartTrades = 9;
extern int MaxBackupTrades = 8;
extern int MaxBasketTrades = 10;
extern double MarginUsage = 0.05;
extern double TradeSpace = 1;
...
int init(){ 
   ...
   prepare();   
   int handle=FileOpen( "milestone" + MAGIC + ".csv", FILE_CSV|FILE_WRITE, ';' );
   if( handle > 0 ){
   ...
   handle = FileOpen( "milestone"+MAGIC+".csv", FILE_CSV|FILE_READ );
   if( handle > 0 ) { 
...
void preparMilestone(){
   accountLimit = AccountLimit * milestoneCount * MileGrowth;
   accountReserve = accountReserve * milestoneCount * MileGrowth;
