...
extern bool EarlyExitsFront = true;
extern bool EarlyExitsBack = true;
extern bool FixedSpace = false;
extern bool FixedLots = false;
extern string REWARD = ".............................................................................................................";
extern int QueryHistory = 7; 
extern double BasketProfit = 250;
extern double OpenProfit = 6; 
extern double MinProfit =  0.9;


extern double MinGowth =  0.047; 
extern double MaxGowth =  0.073; 
...
extern double MarginUsage = 0.07;
...
void managePositions(){
   if( totalHistoryProfit < 0 && AccountEquity() < AccountBalance() && totalProfit > ( maxAccountEquity - AccountEquity() ) * BasketProfit ) closeAll( "profits" );
...
int start() { 
   ...
   if( CloseAll ) closeAll() ;
      ...
      if( MathAbs( trendStrend ) > MinTrend  ){
