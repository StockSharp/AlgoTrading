...
extern bool StopOnlyFriday = true;
...
extern double BasketProfit = 2;
extern double OpenProfit = 0.1;  
extern double MinProfit =  0.02;
...
void update(){
   ...
   else ObjectSet( "hudCalendar", OBJPROP_YDISTANCE, 30 );  
