...
input int    Signal__PeriodMFI    =37;                  // CBH_BH_MFI(37,11) Period of MFI
input int    Signal__PeriodMA     =11;                  // CBH_BH_MFI(37,11) Period of MA
input double Signal__Weight       =1.0;                 // CBH_BH_MFI(37,11) Weight [0...1.0]
//--- inputs for money
...
//--- Creating filter CBH_BH_MFI
   CBH_BH_MFI *filter0=new CBH_BH_MFI;
   if(filter0==NULL)
     {
      //--- failed
