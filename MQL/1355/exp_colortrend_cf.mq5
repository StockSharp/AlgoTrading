...
//+---------------------------------------------------+
//| ¬ходные параметры индикатора Exp_ColorTrend_CF    |
//+---------------------------------------------------+
input ENUM_TIMEFRAMES InpInd_Timeframe=PERIOD_H4; //indicator time frame
//----
input uint CfPeriod = 30; // indicator period 
//----
...
int OnInit()
  {
//---- getting the ColorTrend_CF indicator handle
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"ColorTrend_CF",CfPeriod);
   if(InpInd_Handle==INVALID_HANDLE) Print(" Failed to get handle of ColorTrend_CF indicator");

//---- initialization of a variable for storing a chart period in seconds  
   TimeShiftSec=PeriodSeconds(InpInd_Timeframe);

//---- Initialization of variables of the start of data calculation
   min_rates_total=int(CfPeriod); 
