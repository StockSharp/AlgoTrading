...
int OnInit()
  {
//---- получение хендла индикатора FractalAMA_MBK
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"FractalAMA_MBK",RPeriod,multiplier,signal_multiplier,0);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора FractalAMA_MBK");
      return(INIT_FAILED);
     }
