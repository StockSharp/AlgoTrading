//+------------------------------------------------------------------+
//|                                   Exp_AnchoredMomentumCandle.mq5 |
...
//+---------------------------------------------------------+
//| Входные параметры для индикатора AnchoredMomentumCandle |
//+---------------------------------------------------------+
...
int OnInit()
  {
//---- получение хендла индикатора AnchoredMomentumCandle
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"AnchoredMomentumCandle",MomPeriod,SmoothPeriod,0,0);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print("Не удалось получить хендл индикатора AnchoredMomentumCandle");
      return(INIT_FAILED);
     }
