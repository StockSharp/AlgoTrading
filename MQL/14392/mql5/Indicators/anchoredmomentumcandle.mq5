...
#property description "AnchoredMomentumCandle"
...
//---- получение хендлов индикатора iAnchoredMomentum
   Ind_Handle[0]=iCustom(NULL,0,"AnchoredMomentum",MomPeriod,SmoothPeriod,PRICE_OPEN,0,0,0);
   if(Ind_Handle[0]==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора iAnchoredMomentum["+string(0)+"]!");
      return(INIT_FAILED);
     }
//---
   Ind_Handle[1]=iCustom(NULL,0,"AnchoredMomentum",MomPeriod,SmoothPeriod,PRICE_HIGH,0,0,0);
   if(Ind_Handle[1]==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора iAnchoredMomentum["+string(1)+"]!");
      return(INIT_FAILED);
     }
//---
   Ind_Handle[2]=iCustom(NULL,0,"AnchoredMomentum",MomPeriod,SmoothPeriod,PRICE_LOW,0,0,0);
   if(Ind_Handle[2]==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора iAnchoredMomentum["+string(2)+"]!");
      return(INIT_FAILED);
     }
//---
   Ind_Handle[3]=iCustom(NULL,0,"AnchoredMomentum",MomPeriod,SmoothPeriod,PRICE_CLOSE,0,0,0);
   if(Ind_Handle[3]==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора iAnchoredMomentum["+string(3)+"]!");
      return(INIT_FAILED);
     }
...
//---- имя для окон данных и метка для субъокон 
   string short_name="AnchoredMomentumCandle";
