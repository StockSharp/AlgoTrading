...
int OnInit()
  {
//--- получение хендла индикатора SimpleBars
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"SimpleBars",rperiod,useclose);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора SimpleBars");
      return(INIT_FAILED);
     }
