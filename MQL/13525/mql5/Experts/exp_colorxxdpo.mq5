...
//+----------------------------------------------+
//| Входные параметры индикатора ColorXXDPO      |
//+----------------------------------------------+
...
input uint Length1=21; // Глубина  усреднения DPO
...
input uint Length2= 5; // Глубина сглаживания индикатора
...
int OnInit()
  {
//---- получение хендла индикатора ColorXXDPO
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"ColorXXDPO",MA_Method1,Length1,Phase1,MA_Method2,Length2,Phase2,IPC,0);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора ColorXXDPO");
      return(INIT_FAILED);
     }
