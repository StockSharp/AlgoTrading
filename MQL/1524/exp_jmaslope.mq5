...
int OnInit()
  {
//---- getting the JMASlope indicator handle
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"JMASlope",jLength,jPhase,IPC,0);
   if(InpInd_Handle==INVALID_HANDLE) Print(" Failed to get handle of JMASlope indicator");
