...
//+-----------------------------------------------------+
//| Входные параметры для индикатора KalmanFilterCandle |
//+-----------------------------------------------------+
...
int OnInit()
  {
//---- получение хендла индикатора KalmanFilterCandle
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"KalmanFilterCandle",K,0,0);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print("Не удалось получить хендл индикатора KalmanFilterCandle");
      return(INIT_FAILED);
     }
