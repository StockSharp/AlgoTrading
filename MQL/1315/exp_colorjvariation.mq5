...
//+----------------------------------------------+
//| ColorJVariation indicator input parameters   |
//+----------------------------------------------+
input ENUM_TIMEFRAMES InpInd_Timeframe=PERIOD_D1; //indicator time frame
//----
...
int OnInit()
  {
//---- getting the ColorJVariation indicator handle
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"ColorJVariation",Period_,MA_Method_,JLength_,JPhase_,0);
   if(InpInd_Handle==INVALID_HANDLE) Print(" Failed to get handle of ColorJVariation indicator");

//---- initialization of a variable for storing a chart period in seconds  
   TimeShiftSec=PeriodSeconds(InpInd_Timeframe);

//---- Initialization of variables of the start of data calculation
   min_rates_total=3*Period_+1;
   min_rates_total+=30;
