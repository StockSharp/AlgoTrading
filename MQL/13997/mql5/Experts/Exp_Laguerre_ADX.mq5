...
//+--------------------------------------------------+
//| Входные параметры для индикатора Laguerre_ADX |
//+--------------------------------------------------+
...
int OnInit()
  {
//---- получение хендла индикатора Laguerre_ADX
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"Laguerre_ADX",ADXPeriod,gamma,0);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print("Не удалось получить хендл индикатора Laguerre_ADX");
      return(INIT_FAILED);
     }
