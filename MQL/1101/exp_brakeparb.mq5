...
//+----------------------------------------------+
//| BrakeParb indicator input parameters         |
//+----------------------------------------------+
...
int OnInit()
  {
//---- getting handle of the BrakeParb indicator
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"BrakeParb",A,B,biginShift);
   if(InpInd_Handle==INVALID_HANDLE) Print(" Failed to get handle of BrakeParb indicator");
