...
int OnInit()
  {
//---- получение хендла индикатора RSI_Histogram
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"RSI_Histogram",RSIPeriod,RSIPrice,HighLevel,LowLevel,0);
   if(InpInd_Handle==INVALID_HANDLE) Print(" Не удалось получить хендл индикатора RSI_Histogram");
