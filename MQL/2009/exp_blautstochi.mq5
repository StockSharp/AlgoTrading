...
//+----------------------------------------------+
//| Input parameters of the BlauTStochI indicator|
//+----------------------------------------------+
...
input uint XLength=20;                            // Period of Momentum
input uint XLength1=5;                            // Depth of the first averaging
input uint XLength2=8;                            // Depth of the second averaging
...
int OnInit()
  {
//--- getting the handle of BlauTStochI
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"BlauTStochI",XMA_Method,XLength,XLength1,XLength2,XLength3,XPhase,IPC);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Failed to get the handle of BlauTStochI");
      return(INIT_FAILED);
     }
