...
int OnInit()
  {
//--- getting the handle of the BlauErgodic indicator
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"BlauErgodic",
                         XMA_Method,XLength,XLength1,XLength2,XLength3,XLength4,XPhase,IPC);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Failed to get the handle of the BlauErgodic indicator");
      return(INIT_FAILED);
     }
