...
//+----------------------------------------------+
//| ¬ходные параметры индикатора VininI_Trend    |
//+----------------------------------------------+
...
int OnInit()
  {
//---- getting the VininI_Trend indicator handle
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"VininI_Trend",MA_Method1,Length1,Phase1,
                         MA_Step,MA_Count,MA_Method2,Length2,Phase2,IPC,UpLevel,DnLevel,0);
   if(InpInd_Handle==INVALID_HANDLE) Print(" Failed to get handle of VininI_Trend indicator");
...
//---- Initialization of variables of the start of data calculation
   min_rates_total=XMA.GetStartBars(MA_Method1,Length1+MA_Step*(MA_Count-1),Phase1);
   min_rates_total+=XMA.GetStartBars(MA_Method2,Length2,Phase2);
