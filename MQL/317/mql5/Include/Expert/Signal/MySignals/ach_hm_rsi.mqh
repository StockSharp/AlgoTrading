...
//| Class=CH_HM_RSI                                                  |
//| Page=                                                            |
//| Parameter=PeriodRSI,int,33,Period of RSI                         |
//| Parameter=PeriodMA,int,2, Period of MA                           |
//+------------------------------------------------------------------+
...
//+------------------------------------------------------------------+
class CH_HM_RSI : public CCandlePattern
  {
protected:
...
//+------------------------------------------------------------------+
//| Constructor CH_HM_RSI.                                          |
//| INPUT:  no.                                                      |
//| OUTPUT: no.                                                      |
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
void CH_HM_RSI::CH_HM_RSI()
  {
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CH_HM_RSI::ValidationSettings()
  {
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CH_HM_RSI::InitIndicators(CIndicators *indicators)
  {
//--- check pointer
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CH_HM_RSI::InitRSI(CIndicators *indicators)
  {
//--- check pointer
   if(indicators==NULL) return(false);
...
int CH_HM_RSI::LongCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of Hammer and RSI<40
...
int CH_HM_RSI::ShortCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of Hanging Man pattern and RSI>60     
