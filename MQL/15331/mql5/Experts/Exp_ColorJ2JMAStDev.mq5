...
int OnInit()
  {
//---- получение хендла индикатора ColorJ2JMAStDev
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"ColorJ2JMAStDev",Length1,Length2,Phase1,Phase2,IPC,0,0,dK1,dK2,std_period);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора ColorJ2JMAStDev");
      return(INIT_FAILED);
     }
