...
//---- getting the XMA_Range_Bands indicator handle
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"XMA_Range_Bands",
                         MA_Method1,Length1,Phase1,MA_Method2,Length2,Phase2,Deviation,IPC,0,0);
   if(InpInd_Handle==INVALID_HANDLE) Print(" Failed to get handle of XMA_Range_Bands indicator");
