...
//+----------------------------------------------+
//| Input parameters of the BlauCMI indicator    |
//+----------------------------------------------+
...
int OnInit()
  {
//---- getting handle of the BlauCMI indicator
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"BlauCMI",XMA_Method,XLength,XLength1,XLength2,XLength3,XPhase,IPC1,IPC2,0);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Failed to get handle of the BlauCMI indicator");
      return(INIT_FAILED);
     }
