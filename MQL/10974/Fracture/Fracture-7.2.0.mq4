...
void openPosition(){ 
   ...
   if( rangingMarket && eADX < ADXLine ){ 
    ...
    if( totalScalping < MaxScalping && eADX > ADXLine ){ 
...
void prepareTrend(){ 
   ...
   for( int i = 0; i < CrossBars; i++ ){ 
      ...
      if( tMA1Cur > tMA2Cur && tMA1Prev <= tMA2Prev && Close[0] > MA1Cur  && eADX < 55 ) shortBearishCross1 = true;
      if( tMA2Cur < tMA3Cur && tMA2Prev >= tMA3Prev && Close[0] > MA1Cur  && eADX < 55 ) shortBearishCross2 = true; 
      if( tMA1Cur < tMA2Cur && tMA1Prev >= tMA2Prev && Close[0] < MA1Cur  && eADX < 55 ) shortBullishCross1 = true;
      if( tMA2Cur > tMA3Cur && tMA2Prev <= tMA3Prev && Close[0] < MA1Cur  && eADX < 55 ) shortBullishCross2 = true;  
