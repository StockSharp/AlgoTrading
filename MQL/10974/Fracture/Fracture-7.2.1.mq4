...
void openPosition(){ 
   ...
   if( rangingMarket && eADX < ADXLine ){ 
      ...
      if(  shortBullishCross1 && shortBullishCross2 && totalOpenScalpingBuys < MaxScalping && Close[0] >= fractalUpPrice )  
         OrderSend( Symbol(), OP_BUY, lotSize, Ask, slippage, 0, 0, "scalp", MAGIC ) ;  
      if(   shortBearishCross1 && shortBearishCross2 && totalOpenScalpingSells < MaxScalping && Close[0] <= fractalDownPrice )  
