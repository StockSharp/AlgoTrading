...
void prepareTrend(){ 
   ...
   for( int i = 0; i < 30; i++ ){ 
      ...
      if( tMA1Cur > tMA2Cur && tMA1Prev <= tMA2Prev && Close[0] > MA3Cur && Close[0] > Open[0] ) shortBullishCross1 = true; 
      if( tMA2Cur < tMA3Cur && tMA2Prev >= tMA3Prev && Close[0] > MA3Cur && Close[0] > Open[0] ) shortBullishCross2 = true; 
      if( tMA1Cur < tMA2Cur && tMA1Prev >= tMA2Prev && Close[0] < MA3Cur && Close[0] < Open[0] ) shortBearishCross1 = true;
      if( tMA2Cur > tMA3Cur && tMA2Prev <= tMA3Prev && Close[0] < MA3Cur && Close[0] < Open[0] ) shortBearishCross2 = true;  
