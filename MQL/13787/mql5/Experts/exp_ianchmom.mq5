...
int OnInit()
  {
//---- получение хендла индикатора iAnchMom
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"iAnchMom",SMAPeriod,EMAPeriod,IPC,0);
   if(InpInd_Handle==INVALID_HANDLE)  
     {
      Print(" Не удалось получить хендл индикатора iAnchMom");
      return(INIT_FAILED);
     }
