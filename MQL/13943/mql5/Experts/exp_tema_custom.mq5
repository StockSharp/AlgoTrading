...
//+----------------------------------------------+
//| Входные параметры индикатора TEMA_CUSTOM     |
//+----------------------------------------------+
...
int OnInit()
  {
//---- получение хендла индикатора TEMA_CUSTOM
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"TEMA_CUSTOM",MA_Method1,Length1,Phase1,MA_Method2,Length2,Phase2,MA_Method3,Length3,Phase3,IPC,0,0);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора TEMA_CUSTOM");
      return(INIT_FAILED);
     }
