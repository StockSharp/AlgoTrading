...
input uchar    Stepper=1;//Stepper for real
input uchar    Stepper_v=2;//Stepper for virtual
extern double  Pipstep=18;//PipStep
...
extern bool     visual=true;//Visual
int            Tick,di_2,pr_60,n_virt_buy=0,n_virt_sell=0;
double         gpoint_320,
mn_digits,
pips_buy[31],pips_sell[31],lots_buy[31],lots_sell[31],
virt_orders_0[31],
virt_orders_1[31],
virt_lots_0[31],
virt_lots_1[31],
   ...
   if((Close_1>Open_1 && n_virt_buy==0) || (n_virt_buy>0 && virt_orders_0[n_virt_buy]-Ask>PipStep))
     {
      ...
      virt_orders_0[n_virt_buy]=no_5(Ask);
   ...
   if((Close_1<Open_1 && n_virt_sell==0) || (n_virt_sell>0 && Bid-virt_orders_1[n_virt_sell]>PipStep && Bid>pips_sell[n_virt_sell]))
     {
      ...
      virt_orders_1[n_virt_sell]=no_5(Bid);
