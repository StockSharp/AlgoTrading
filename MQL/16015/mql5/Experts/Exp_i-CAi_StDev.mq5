...
int OnInit()
  {
//---- получение хендла индикатора i-CAi_StDev
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"i-CAi_StDev",XMA_Method,XLength,XPhase,IPC,0,dK1,dK2,std_period,0);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора i-CAi_StDev");
      return(INIT_FAILED);
     }
