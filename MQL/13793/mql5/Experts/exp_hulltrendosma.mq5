...
int OnInit()
  {
//---- получение хендла индикатора HullTrendOSMA
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"HullTrendOSMA",XLength,IPC,XMA_Method,XPhase,XLength1,XMA_Method1,XPhase1);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора HullTrendOSMA");
      return(INIT_FAILED);
     }
