...
//---
input uint countBarsS=96;
input uint countBarsL=288;
//---
...
int OnInit()
  {
//--- получение хендла индикатора ExchangePrice
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"ExchangePrice",countBarsS,countBarsL);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора ExchangePrice");
      return(INIT_FAILED);
     }
