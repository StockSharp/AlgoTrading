...
int OnInit()
  {
//---- получение хендла индикатора WPR_Histogram
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"WPR_Histogram",WPRPeriod,HighLevel,LowLevel,0);
   if(InpInd_Handle==INVALID_HANDLE) Print(" Не удалось получить хендл индикатора WPR_Histogram");
