...
(
 ...
 const datetime &TimeLevel,  // the time, after which the next deal will be performed after the current one
...
//+------------------------------------------------------------------+
//| return symbol with specified deposit currency and quotes         |
//+------------------------------------------------------------------+
