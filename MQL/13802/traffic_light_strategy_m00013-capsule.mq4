...
#property strict
//---
extern string s1="Риск MM и параметры ордера";
...
//---
extern string s2="Торговые настройки";
...
extern double      TakeProfit         = 240;    // тейкпрофит в пунктах
...
//---
extern string s3="Трейлинг стоп Настройки";
extern int         Trailing           = 1;      // 1 трейлингстоп (0 - отключен)
extern double      TrailOtstupiMA     = 5;      // отступ стоплосса от iMA
extern double      TrailStep          = 3;      // шаг трейлинга
extern int         TralliMA           = 85;     // трейлинг iMA
//---
extern string s4="Сигналы индикаторов";
...
//+------------------------------------------------------------------+
//| Трейлинг-стоп по скользящей iMA                                  |
//+------------------------------------------------------------------+
