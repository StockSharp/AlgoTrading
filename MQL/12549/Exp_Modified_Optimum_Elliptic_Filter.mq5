//+------------------------------------------------------------------+
//|                         Exp_Modified_Optimum_Elliptic_Filter.mq5 |
...
int OnInit()
  {
//--- получение хендла индикатора Modified_Optimum_Elliptic_Filter
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"Modified_Optimum_Elliptic_Filter",0);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора Modified_Optimum_Elliptic_Filter");
      return(INIT_FAILED);
     }
