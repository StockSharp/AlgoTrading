...
//+----------------------------------------------+
input ENUM_TIMEFRAMES InpInd_Timeframe=PERIOD_H4; //timeframe of the DSSBressert indicator
//----
...
int OnInit()
  {
//---- getting the DSSBressert indicator handle
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"DSSBressert",EMA_period,Sto_period,0);
   if(InpInd_Handle==INVALID_HANDLE) Print(" Failed to get handle of DSSBressert indicator");
