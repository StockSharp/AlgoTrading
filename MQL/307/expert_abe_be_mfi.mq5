...
input int    Signal__PeriodMFI    =37;                  // CBE_BE_MFI(37,5) Period of MFI
input int    Signal__PeriodMA     =5;                   // CBE_BE_MFI(37,5) Period of MA
input double Signal__Weight       =1.0;                 // CBE_BE_MFI(37,5) Weight [0...1.0]
//--- inputs for money
...
//--- Creating filter CBE_BE_MFI
   CBE_BE_MFI *filter0=new CBE_BE_MFI;
   if(filter0==NULL)
     {
      //--- failed
