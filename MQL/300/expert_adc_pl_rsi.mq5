...
input int    Signal__PeriodRSI    =20;                  // CDC_PL_RSI(20,14) Period of RSI
input int    Signal__PeriodMA     =14;                  // CDC_PL_RSI(20,14) Period of MA
input double Signal__Weight       =1.0;                 // CDC_PL_RSI(20,14) Weight [0...1.0]
//--- inputs for money
...
//--- Creating filter CDC_PL_RSI
   CDC_PL_RSI *filter0=new CDC_PL_RSI;
   if(filter0==NULL)
     {
      //--- failed
