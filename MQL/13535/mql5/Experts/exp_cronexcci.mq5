...
int OnInit()
  {
//---- получение хендла индикатора CronexCCI
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"CronexCCI",CCIPeriod,CCIPrice,XMA_Method,FastPeriod,SlowPeriod,XPhase,0);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора CronexCCI");
      return(INIT_FAILED);
     }
