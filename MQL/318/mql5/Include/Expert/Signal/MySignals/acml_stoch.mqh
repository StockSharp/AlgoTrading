...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CML_Stoch::InitStoch(CIndicators *indicators)
  {
...
int CML_Stoch::LongCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of Bullish Meeting Lines pattern and
...
int CML_Stoch::ShortCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of Bearish Meeting Lines pattern and
