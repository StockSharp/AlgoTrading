...
//+----------------------------------------------+
input ENUM_TIMEFRAMES InpInd_Timeframe=PERIOD_H4; // таймфрейм индикатора Donchian_Channels_System
...
int OnInit()
  {
//---- получение хендла индикатора Donchian_Channels_System
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"Donchian_Channels_System",DonchianPeriod,Extremes,Margins,Shift);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора Donchian_Channels_System");
      return(INIT_FAILED);
     }
