...
//| Parameter=PeriodMA,int,51, Period of MA                          |
//+------------------------------------------------------------------+
...
//+------------------------------------------------------------------+
class CBC_WS_RSI : public CCandlePattern
  {
protected:
...
//+------------------------------------------------------------------+
//| Constructor CBC_WS_RSI.                                          |
//| INPUT:  no.                                                      |
//| OUTPUT: no.                                                      |
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
void CBC_WS_RSI::CBC_WS_RSI()
  {
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CBC_WS_RSI::ValidationSettings()
  {
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CBC_WS_RSI::InitIndicators(CIndicators *indicators)
  {
//--- check pointer
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CBC_WS_RSI::InitRSI(CIndicators *indicators)
  {
//--- check pointer
   if(indicators==NULL) return(false);
...
int CBC_WS_RSI::LongCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of 3 White Soldiers and RSI<40
...
int CBC_WS_RSI::ShortCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of 3 Black Crows pattern and RSI>60     
