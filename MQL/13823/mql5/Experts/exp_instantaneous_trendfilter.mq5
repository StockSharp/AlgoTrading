//+------------------------------------------------------------------+
//|                                Exp_Instantaneous_TrendFilter.mq5 |
...
int OnInit()
  {
//---- получение хендла индикатора Instantaneous_TrendFilter
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"Instantaneous_TrendFilter",Alpha,0);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print("Не удалось получить хендл индикатора Instantaneous_TrendFilter");
      return(INIT_FAILED);
     }
