...
//+----------------------------------------------+
//| XRVI indicator input parameters              |
//+----------------------------------------------+
...
//---- getting the XRVI indicator handle
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"XRVI",RviMethod,RviPeriod,RviPhase,SignMethod,SignPeriod,SignPhase,IPC,0);
   if(InpInd_Handle==INVALID_HANDLE) Print(" Failed to get handle of XRVI indicator");
