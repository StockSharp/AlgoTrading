...
//+--------------------------------------------------+
//| Входные параметры для индикатора MACDCandle      |
//+--------------------------------------------------+
...
input MODE  mode=MODE_SIGNAL_LINE;          // Источник данных для расчета
//+--------------------------------------------------+
