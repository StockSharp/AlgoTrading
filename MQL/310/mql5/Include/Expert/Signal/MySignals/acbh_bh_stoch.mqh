...
//+------------------------------------------------------------------+
class CBH_BH_Stoch : public CCandlePattern
  {
protected:
...
//+------------------------------------------------------------------+
//| CBH_BH_Stoch class constructor.                                  |
//| INPUT:  no.                                                      |
//| OUTPUT: no.                                                      |
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
void CBH_BH_Stoch::CBH_BH_Stoch()
  {
//--- set default inputs
   m_periodK    =7;
   m_periodD    =11;
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CBH_BH_Stoch::ValidationSettings()
  {
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CBH_BH_Stoch::InitIndicators(CIndicators *indicators)
  {
//--- check
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CBH_BH_Stoch::InitStoch(CIndicators *indicators)
  {
...
int CBH_BH_Stoch::LongCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of Bullish Harami pattern and
...
int CBH_BH_Stoch::ShortCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of three Bearish Harami pattern and
//--- check signal line of stochastic indicator
