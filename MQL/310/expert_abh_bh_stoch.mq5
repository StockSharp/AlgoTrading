...
input int            Signal__StochPeriodK   =47;          // CBH_BH_Stoch(47,9,13,...) 
input int            Signal__StochPeriodD   =9;           // CBH_BH_Stoch(47,9,13,...) 
input int            Signal__StochPeriodSlow=13;          // CBH_BH_Stoch(47,9,13,...) 
input ENUM_STO_PRICE Signal__StochApplied   =STO_LOWHIGH; // CBH_BH_Stoch(47,9,13,...) 
input int            Signal__MAPeriod       =5;           // CBH_BH_Stoch(47,9,13,...) 
input double         Signal__Weight         =1.0;         // CBH_BH_Stoch(47,9,13,...) Weight [0...1.0]
//--- inputs for money
...
//--- Creating filter CBH_BH_Stoch
   CBH_BH_Stoch *filter0=new CBH_BH_Stoch;
   if(filter0==NULL)
     {
      //--- failed
