...
int OnInit()
  {
//---- получение хендла индикатора ColorMETRO_XRSX
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"ColorMETRO_XRSX",DSmoothMethod,DPeriod,DPhase,StepSizeFast,StepSizeSlow,IPC,0);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора ColorMETRO_XRSX");
      return(INIT_FAILED);
     }
