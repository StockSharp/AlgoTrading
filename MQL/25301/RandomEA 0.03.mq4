...
void OnTick()
{
   ...
   if(BuyIsActive == True && AccountEquity() > AccountBalance() + (AccountBalance() * 0.002)){CloseTrades();BuyIsActive = False;} 
   if(SellIsActive == True && AccountEquity() > AccountBalance() + (AccountBalance() * 0.002)){CloseTrades();SellIsActive = False;}
