...
int OnInit()
  {
//---- получение хендла индикатора ADXDMI
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"ADXDMI",DMIPeriod,Smooth,0);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора ADXDMI");
      return(INIT_FAILED);
     }
