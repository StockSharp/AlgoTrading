...
//+----------------------------------------------+
//| Входные параметры индикатора ColorBullsGap   |
//+----------------------------------------------+
...
int OnInit()
  {
//---- получение хендла индикатора ColorBullsGap
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"ColorBullsGap",MA_Method1,Length1,Phase1,MA_Method2,Length2,Phase2,0);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора ColorBullsGap");
      return(INIT_FAILED);
     }
