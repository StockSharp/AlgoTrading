...
//+----------------------------------------------+
//| BrakeExp indicator input parameters          |
//+----------------------------------------------+
...
int OnInit()
  {
//---- getting handle of the BrakeExp indicator
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"BrakeExp",A,B);
   if(InpInd_Handle==INVALID_HANDLE) Print(" Failed to get handle of BrakeExp indicator");
