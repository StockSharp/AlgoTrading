...
//---- getting the VininI_Trend_LRMA indicator handle
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"VininI_Trend_LRMA",LRMAPeriod,
                         MA_Method1,Length1,Phase1,MA_Step,MA_Count,MA_Method2,Length2,Phase2,IPC,UpLevel,DnLevel,0);
   if(InpInd_Handle==INVALID_HANDLE) Print(" Failed to get handle of VininI_Trend_LRMA indicator");
...
//---- Initialization of variables of the start of data calculation
   min_rates_total=int(LRMAPeriod); 
