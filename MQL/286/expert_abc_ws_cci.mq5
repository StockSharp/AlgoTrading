...
input int    Signal__PeriodCCI    =37;                  // CBC_WS_CCI(37,13) Period of CCI
input int    Signal__PeriodMA     =13;                  // CBC_WS_CCI(37,13) Period of MA
input double Signal__Weight       =1.0;                 // CBC_WS_CCI(37,13) Weight [0...1.0]
//--- inputs for money
...
//--- Creating filter CBC_WS_CCI
   CBC_WS_CCI *filter0=new CBC_WS_CCI;
   if(filter0==NULL)
     {
      //--- failed
