...
//| Class=CBC_WS_CCI                                                 |
//| Page=                                                            |
//| Parameter=PeriodCCI,int,37,Period of CCI                         |
...
//+------------------------------------------------------------------+
class CBC_WS_CCI : public CCandlePattern
  {
protected:
...
//+------------------------------------------------------------------+
//| Constructor CBC_WS_CCI.                                          |
//| INPUT:  no.                                                      |
//| OUTPUT: no.                                                      |
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
void CBC_WS_CCI::CBC_WS_CCI()
  {
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CBC_WS_CCI::ValidationSettings()
  {
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CBC_WS_CCI::InitIndicators(CIndicators *indicators)
  {
//--- check pointer
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CBC_WS_CCI::InitCCI(CIndicators *indicators)
  {
//--- check pointer
   if(indicators==NULL) return(false);
...
int CBC_WS_CCI::LongCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of 3 White Soldiers and CCI<-50
...
int CBC_WS_CCI::ShortCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of 3 Black Crows pattern and CCI>50
