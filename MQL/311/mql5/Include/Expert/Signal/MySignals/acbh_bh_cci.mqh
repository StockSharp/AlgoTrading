...
//+------------------------------------------------------------------+
class CBH_BH_CCI : public CCandlePattern
  {
protected:
...
//+------------------------------------------------------------------+
//| Constructor CBH_BH_CCI.                                          |
//| INPUT:  no.                                                      |
//| OUTPUT: no.                                                      |
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
void CBH_BH_CCI::CBH_BH_CCI()
  {
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CBH_BH_CCI::ValidationSettings()
  {
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CBH_BH_CCI::InitIndicators(CIndicators *indicators)
  {
//--- check pointer
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CBH_BH_CCI::InitCCI(CIndicators *indicators)
  {
//--- check pointer
   if(indicators==NULL) return(false);
...
int CBH_BH_CCI::LongCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of Bullish Harami and CCI<-50
...
int CBH_BH_CCI::ShortCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of Bearish Harami pattern and CCI>50
