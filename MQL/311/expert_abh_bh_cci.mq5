...
input int    Signal__PeriodCCI    =11;                  // CBH_BH_CCI(11,5) Period of CCI
input int    Signal__PeriodMA     =5;                   // CBH_BH_CCI(11,5) Period of MA
input double Signal__Weight       =1.0;                 // CBH_BH_CCI(11,5) Weight [0...1.0]
//--- inputs for money
...
//--- Creating filter CBH_BH_CCI
   CBH_BH_CCI *filter0=new CBH_BH_CCI;
   if(filter0==NULL)
     {
      //--- failed
