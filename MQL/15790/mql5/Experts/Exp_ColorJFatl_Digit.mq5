...
int OnInit()
  {
//---- получение хендла индикатора ColorJFatl_Digit
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"ColorJFatl_Digit","ColorJFatl_Digit",JLength,JPhase,IPC,0,0,Digit,true,clrGray);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора ColorJFatl_Digit");
      return(INIT_FAILED);
     }
