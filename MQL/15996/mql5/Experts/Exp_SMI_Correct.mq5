...
//+----------------------------------------------+
//| Входные параметры индикатора Exp_ColorMETRO  |
//+----------------------------------------------+
...
int OnInit()
  {
//---- получение хендла индикатора SMI_Correct
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"SMI_Correct",
                         ExtrPeriod,MA_Method1,Length1,Phase1,MA_Method2,Length2,Phase2,MA_Method3,Length3,Phase3,IPC,0,0,0,0,clrNONE,clrNONE,clrNONE);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора SMI_Correct");
      return(INIT_FAILED);
     }
