...
int OnInit()
  {
//---- получение хендла индикатора Volume_Weighted_MA
   InpInd_Handle=iCustom(Symbol(),InpInd_Timeframe,"Volume_Weighted_MA",Length,IPC,VolumeType,0,0);
   if(InpInd_Handle==INVALID_HANDLE)
     {
      Print(" Не удалось получить хендл индикатора Volume_Weighted_MA");
      return(INIT_FAILED);
     }
