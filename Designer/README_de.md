...
Wenn Sie eine Strategie entwickelt oder eine Verbesserung eines bestehenden Beispiels vorgenommen haben, die anderen zugutekommen könnte, tragen Sie gerne dazu bei:

- **Fork und Clone**: Forken Sie dieses Repository und klonen Sie es auf Ihren lokalen Rechner.
- **Fügen Sie Ihr Beispiel hinzu**: Fügen Sie Ihre schematische oder C#-Datei dem entsprechenden Ordner mit einem beschreibenden Namen hinzu.
- **Dokumentieren Sie Ihre Strategie**: Stellen Sie eine README.md-Datei oder Kommentare in Ihrem Code zur Verfügung, um die Logik, Verwendung und alle relevanten Details Ihrer Strategie zu erläutern.
- **Erstellen Sie einen Pull Request**: Reichen Sie einen Pull Request mit einer detaillierten Beschreibung Ihrer Strategie ein und erläutern Sie, wie sie zum Lernen oder zur Funktionalität der Designer-Strategien beiträgt.

## Support und Diskussion

Wenn Sie Probleme mit einem der Beispiele haben oder Fragen haben, öffnen Sie bitte ein Issue in diesem Repository. Für allgemeine Diskussionen oder um Rat von der Community zu suchen, besuchen Sie die StockSharp-Foren oder Community-Kanäle.

Vielen Dank für Ihren Besuch im Designer-Strategien Beispielverzeichnis. Wir hoffen, dass diese Ressourcen Ihre Entwicklung von Handelsstrategien verbessern und Sie dazu ermutigen, sich in der StockSharp-Community zu engagieren.
