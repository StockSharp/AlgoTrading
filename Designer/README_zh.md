...
如果您开发了一个策略或对现有示例进行了改进，认为可以使他人受益，欢迎贡献：

- **Fork 并克隆**：Fork 本仓库并将其克隆到本地机器。
- **添加您的示例**：将您的图形化或 C# 文件添加到相应文件夹，并使用描述性名称。
- **记录您的策略**：提供 README.md 文件或代码注释，解释策略的逻辑、用法及相关细节。
- **创建 Pull Request**：提交 Pull Request，详细描述您的策略以及它如何为 Designer 策略的学习或功能做出贡献。

## 支持与讨论

如果您在使用任何示例时遇到问题或有疑问，请在本仓库中开启 Issue。此外，如需一般性讨论或向社区寻求建议，请访问 StockSharp 论坛或社区频道。

感谢您访问 Designer 策略示例目录。希望这些资源能够提升您的交易策略开发水平，并鼓励您参与 StockSharp 社区。
