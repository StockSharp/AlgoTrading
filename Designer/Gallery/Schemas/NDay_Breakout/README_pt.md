...
- **Saída**: Sem stop, sem alvo e sem saída própria: a posição permanece até que o rompimento contrário a inverta.
...
- Os blocos de comparação produzem as duas bandeiras de rompimento e outros dois comparam a posição com zero; um NÃO lógico dá prioridade ao rompimento de alta sobre o de baixa.
...
- O diagrama usa um canal de 20 barras em candles de cinco minutos e expõe apenas os parâmetros que afetam suas decisões.
