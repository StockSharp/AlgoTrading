...
2つのオシレーターが同じ足で一致する必要があります。RSI が30を下抜けると同時にウィリアムズ %R が -80 を下抜けたときだけ買い、RSI が70を上抜けると同時にウィリアムズ %R が -20 を上抜けたときだけ売ります。単にゾーンの中にあるだけでは不足で、前の足では両方ともゾーンの外にいなければなりません。そのため各オシレーターは1本前の値も保持します。
