...
- **Выход**: Лонг закрывается, когда Tenkan-sen уходит обратно под Kijun-sen или закрытие опускается ниже нижней границы облака; шорт — зеркально. Объём закрывающей заявки берётся из позиции, поэтому диаграмма возвращается в ноль, а не переворачивается; стоп-лосса и тейк-профита нет.
