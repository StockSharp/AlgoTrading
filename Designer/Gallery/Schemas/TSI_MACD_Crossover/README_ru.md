...
- **Выход**: Собственного правила выхода и защитного стопа нет: позиция держится, пока обратное пересечение её не развернёт. Проверка позиции запрещает повторный вход в ту же сторону, а формула объёма одной рыночной заявкой закрывает старую сторону и открывает новую.
...
| Candles | 01:00:00 | Часовой таймфрейм, дающий дважды сглаженному индексу достаточно завершённых баров для формирования и торговли на месяце истории. |
