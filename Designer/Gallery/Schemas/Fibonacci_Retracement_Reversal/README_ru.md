...
- Для входа дополнительно нужны подтверждающее тело свечи и нулевая позиция; все выходы делает SimpleMovingAverage, а стопа и цели нет.
...
- Диаграмма работает на пятиминутных свечах и может торговать снова, как только условия вернулись. Позиции держатся несколько баров; увеличение периода средней их удлиняет.
