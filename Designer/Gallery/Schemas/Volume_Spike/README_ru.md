...
- Объём свечи сравнивается с объёмом предыдущей свечи, а не со средним за много свечей.
...
- **Выход**: Обе стороны выходят на первой же свече, объём которой меньше объёма предыдущей, через кубики изменения позиции в режиме закрытия. В диаграмме нет ни стоп-лосса, ни тейк-профита.
...
- Сравнение падающего объёма заведено прямо на оба закрывающих кубика: они работают в режиме закрытия и потому бездействуют, пока позиции нет. Диаграмма работает на пятиминутных свечах из поставляемой истории и торгует каждый подходящий всплеск.
