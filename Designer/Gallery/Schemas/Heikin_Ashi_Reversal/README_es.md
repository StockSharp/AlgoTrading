...
- La media móvil y el precio de salida se toman de las velas normales, no de las suavizadas.
- La apertura Heikin-Ashi normalmente se define por su propio valor anterior, algo que un diagrama no puede realimentar a un bloque; en su lugar se usa el punto medio de la vela normal previa, de modo que los cambios de color son una aproximación.
...
- **Salida**: Un largo se cierra con un bloque de modificación de posición en modo cierre cuando una vela normal cierra por debajo de la media móvil; un corto se cierra cuando una cierra por encima. El diagrama no lleva stop loss ni take profit.
