...
- **Ausstieg**: Der Baustein zum Positionsschutz beendet jeden Trade über einen festen prozentualen Stop oder ein festes prozentuales Ziel, gemessen ab dem Ausführungskurs. ATR-basierte Abstände würden erfordern, die Marken im Diagramm zu berechnen und die Orders einzeln zu senden. Stop oder Ziel beenden den Trade, sodass ein Gegensignal eine offene Position nicht dreht. Das Diagramm läuft auf den Fünf-Minuten-Kerzen der mitgelieferten Historie.
