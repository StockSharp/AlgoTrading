...
- **Salida**: El bloque de protección de la posición cierra cada operación con un stop o un objetivo porcentual medidos desde el precio de ejecución. Son distancias porcentuales fijas; usar en su lugar distancias basadas en ATR exigiría calcular los niveles en el diagrama y enviar las órdenes individualmente. El stop o el objetivo termina la operación, por lo que una señal contraria no invierte una posición abierta. El diagrama trabaja con las velas de cinco minutos del histórico incluido.
