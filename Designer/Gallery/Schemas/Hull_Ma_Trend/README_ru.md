...
- После первого сигнала стратегия всегда в рынке: ни стопа, ни тейка, ни нулевой позиции между сделками.
...
|---|---|---|
| Hull MA Length | 100 | Период Hull Moving Average в пятиминутных свечах. |
...
- Кубик предыдущего значения хранит Hull MA прошлой свечи и молчит на первом значении, поэтому первый бар пропускается.
