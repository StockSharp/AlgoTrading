...
- Depois do primeiro sinal a estratégia está sempre no mercado: não há stop, alvo nem estado zerado entre as operações.
...
|---|---|---|
| Hull MA Length | 100 | Comprimento da Hull Moving Average em candles de cinco minutos. |
...
- Um bloco de valor anterior guarda a Hull do candle anterior e fica em silêncio no primeiro valor, por isso a primeira barra é ignorada.
