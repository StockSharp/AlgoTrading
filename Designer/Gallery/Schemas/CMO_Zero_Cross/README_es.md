...
- **Salida**: No hay bloque de salida propio: la posición se abandona por el cruce contrario del cero, que la invierte, o por el bloque de protección. La protección utiliza un objetivo del dos por ciento y un stop del uno por ciento, una relación recompensa-riesgo de dos a uno expresada en porcentajes portátiles. El control de la posición impide una segunda entrada en el mismo sentido.
