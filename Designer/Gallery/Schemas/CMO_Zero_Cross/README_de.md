...
- **Ausstieg**: Es gibt keinen eigenen Ausstiegsbaustein: Die Position wird entweder durch die Gegenkreuzung der Null gedreht oder vom Positionsschutz geschlossen. Der Schutz verwendet ein Ziel von zwei Prozent und einen Stopp von einem Prozent, ein instrumentenunabhängiges Ertrags-Risiko-Verhältnis von zwei zu eins. Die Positionsprüfung verhindert einen zweiten Einstieg in dieselbe Richtung.
