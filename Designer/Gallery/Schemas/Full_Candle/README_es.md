...
- Un bloque de protección de posición cierra cada operación con una toma de beneficios fija, la única salida del diagrama.
...
- **Salida**: El bloque de protección toma beneficios al 0,3 por ciento del precio de entrada y no hay stop de pérdidas. El bloque de protección vigila el precio dentro de la barra, por lo que puede reaccionar antes de que termine la vela. Una señal de giro puede tomarse en cuanto aparece.
...
| Candles | 00:05:00 | Marco temporal de cinco minutos, elegido para que el patrón aparezca con suficiente frecuencia en el histórico incluido. |
