...
- Um bloco de proteção de posição encerra cada operação em um alvo fixo, a única saída do diagrama.
...
- **Saída**: O bloco de proteção realiza lucro a 0,3 por cento do preço de entrada e não há stop. O bloco de proteção acompanha o preço dentro da barra, por isso pode reagir antes de o candle terminar. Um sinal de inversão pode ser executado assim que aparece.
...
| Candles | 00:05:00 | Tempo gráfico de cinco minutos, escolhido para que o padrão apareça com frequência suficiente no histórico incluído. |
