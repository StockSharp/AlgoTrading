...
- Кубик защиты позиции закрывает каждую сделку по фиксированному тейк-профиту — единственному выходу диаграммы.
...
- **Выход**: Кубик защиты позиции фиксирует прибыль в 0,3 процента от цены входа; стоп-лосса нет. Кубик защиты следит за ценой внутри бара, поэтому может сработать до завершения свечи. Сигнал на переворот может быть принят сразу после появления.
...
| Candles | 00:05:00 | Пятиминутный таймфрейм, выбранный так, чтобы паттерн достаточно часто встречался на поставляемой истории. |
