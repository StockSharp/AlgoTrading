...
- The diagram expresses its stop and take distances as percentages of the entry price and operates throughout the day.
- Stochastic confirmation is always active and compares the two current lines. The diagram uses five-minute candles to match the packaged sample history.
...
- **Exit**: The position protection block closes the trade at a fixed percentage from the entry price, either on the take profit or on the stop loss. There is no exit on an opposite MACD cross.
