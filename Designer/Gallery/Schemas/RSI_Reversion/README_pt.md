...
- A SimpleMovingAverage de 50 candles não escolhe direção; ela apenas adia a negociação até estar formada.
...
- **Saída**: Não existe bloco de saída próprio, stop loss nem take profit: o sinal de reversão contrário encerra a posição e abre o outro lado com a mesma ordem.
...
- Cada lado usa dois blocos de comparação que testam a leitura anterior e a atual contra a constante de nível, formando a condição de cruzamento.
- A comparação da SMA com zero atua como verificação de prontidão; como o bloco de indicador só emite valores formados, a negociação começa após cinquenta candles.
