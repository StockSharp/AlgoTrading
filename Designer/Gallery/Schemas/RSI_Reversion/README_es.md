...
- La SimpleMovingAverage de 50 velas no elige dirección; solo retrasa la operativa hasta que está formada.
...
- **Salida**: No hay bloque de salida propio, stop loss ni take profit: la señal de reversión contraria cierra la posición y abre el otro lado con la misma orden.
...
- Cada lado usa dos bloques de comparación que contrastan la lectura anterior y la actual con la constante de nivel, formando la condición de cruce.
- La comparación de la SMA con cero actúa como control de preparación; como el bloque de indicador solo emite valores formados, la operativa comienza tras cincuenta velas.
