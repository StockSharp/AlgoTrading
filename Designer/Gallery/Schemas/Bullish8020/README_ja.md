...
- **説明**：この戦略は、[始値](https://doc.stocksharp.com/ja/topics/designer/strategies/using_visual_designer/elements/data_sources/candles.html)が終値より低く、実体のサイズが両方の影の合計の4倍以上である強気シナリオを検出し、強い買い圧力を示します。
...
- **エントリー**：潜在的な上昇動向を示す 'Bullish8020' [パターン](https://doc.stocksharp.com/ja/topics/designer/strategies/using_visual_designer/elements/common/indicator.html)が確認されたときに買います。
- **エグジット戦略**：
...
- **ストップロス戦略**：予期しない市場反転に備えて厳格な[ストップロス](https://doc.stocksharp.com/ja/topics/designer/strategies/using_visual_designer/elements/common/protect_position.html)を実装しています。
