...
- **Ausstieg**: Ein Long wird geschlossen, wenn der Schlusskurs unter das untere Bollinger-Band fällt, ein Short, wenn er über das obere steigt: Der Ausbruch ist gescheitert und lief in die Gegenrichtung. Beide Ausstiege arbeiten im Schließmodus, ohne Stop-Loss oder Take-Profit.
...
- Ein gleitender Durchschnitt der Bandbreite liefert die Squeeze-Basislinie. Die Richtung kommt vom RSI, und es wird kein separater Balkenzähler-Filter angewandt.
