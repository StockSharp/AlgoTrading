...
- Das exklusive ODER dieser beiden Vergleiche ist genau auf den Kerzen wahr, die den Durchschnitt überspannen; das Signal erkennt also die Kreuzung einer Kerze mit dem Durchschnitt und nicht den Schnitt zweier Indikatorlinien.
...
- **Ausstieg**: Einen eigenen Ausstieg, Stop-Loss oder Take-Profit gibt es nicht: Die Position wird gehalten, bis die Gegenkreuzung sie dreht.
