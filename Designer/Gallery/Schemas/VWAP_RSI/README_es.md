...
- La media es una VolumeWeightedMovingAverage móvil de 32 velas, no un VWAP de sesión, y pondera cada cierre por el volumen negociado en esa vela.
...
- La posición se cierra en cuanto el precio vuelve a cruzar la media.
...
- **Salida**: El largo se cierra cuando el cierre vuelve por encima de la VWMA; el corto, cuando vuelve por debajo. No hay stop loss ni take profit.
