...
- **Salida**: Un largo se cierra en el primer cierre por debajo de la banda central y un corto en el primero por encima. No hay stop ni objetivo.
...
- El diagrama utiliza el ADX estándar suavizado por Wilder como medida de la fuerza de la tendencia.
