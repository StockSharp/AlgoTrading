...
- **Выход**: Лонг закрывается на первом закрытии ниже средней линии, шорт — на первом закрытии выше неё. Стоп-лосса и тейк-профита нет.
...
- В схеме используется штатный сглаженный по Уайлдеру ADX как мера силы тренда.
