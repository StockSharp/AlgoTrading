...
- Стоп-лосса и тейк-профита в диаграмме нет; единственный выход — разворот MACD.
...
- Сравнения по тренду переиспользуются как триггеры выхода, поэтому двум кубикам закрытия не нужна отдельная логика.
