...
Apesar do nome, o diagrama usa uma única série de quatro horas e duas linhas ExponentialMovingAverage de comprimentos diferentes. Ele negocia a concordância das inclinações: enquanto a curta e a longa apontam para cima o diagrama fica comprado, enquanto ambas apontam para baixo fica vendido, e havendo divergência a posição é deixada em paz.
...
- Todas as ordens usam o volume compartilhado fixo, então o sinal contrário apenas zera a posição; abrir para o outro lado exige um segundo sinal do mesmo sentido no candle seguinte.
...
- **Saída**: Não há regra de saída própria: a posição é encerrada pelo sinal contrário, isto é, quando as duas médias viram para o outro lado. O diagrama não tem stop loss, alvo nem pausa entre operações.
...
| Candles | 04:00:00 | Tempo gráfico de quatro horas, que deixa cerca de duzentos candles no mês de histórico incluído. |
