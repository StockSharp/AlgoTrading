...
Несмотря на название, диаграмма использует одну четырёхчасовую серию и две линии ExponentialMovingAverage разной длины. Торгуется совпадение их наклонов: пока и короткая, и длинная средние смотрят вверх, схема стоит в лонге, пока обе смотрят вниз — в шорте, а при расхождении позиция не трогается.
...
- Все заявки идут фиксированным общим объёмом, поэтому встречный сигнал лишь обнуляет позицию; чтобы войти в другую сторону, нужен второй сигнал того же направления на следующей свече.
...
- **Выход**: Собственного правила выхода нет: позицию закрывает противоположный сигнал, то есть момент, когда обе средние развернулись в другую сторону. В схеме нет ни стоп-лосса, ни тейк-профита, ни паузы между сделками.
...
| Candles | 04:00:00 | Четырёхчасовой таймфрейм свечей, дающий около двухсот свечей на поставляемом месяце истории. |
