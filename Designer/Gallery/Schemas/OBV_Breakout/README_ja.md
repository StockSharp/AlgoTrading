...
On-Balance Volume は陽線の出来高を加算し、陰線の出来高を減算するため、その傾きがどちら側が売買しているかを示します。このダイアグラムは1本ずつその傾きだけを読み、価格の単純移動平均がその傾きに従う価値があるかを決めます。フォルダー名に反して、シグナルは OBV をブレイクアウト水準ではなく1本前の自身の値とのみ比較します。
