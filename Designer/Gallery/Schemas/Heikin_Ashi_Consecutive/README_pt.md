...
- A ordem é dimensionada como volume mais a posição absoluta, de modo que uma única ordem vira uma venda direto para compra e vice-versa.
- A abertura Heikin-Ashi é normalmente definida pelo seu próprio valor anterior, algo que um diagrama não consegue realimentar em um bloco; em seu lugar usa-se o ponto médio do candle comum anterior, então as sequências são uma aproximação.
...
- **Saída**: Não há saída separada por sinal: a posição é virada pela sequência contrária ou retirada pelo bloco de proteção, que coloca um stop loss a uma porcentagem fixa do preço de execução. Não há alvo nem stop móvel.
...
| Candles | 00:30:00 | Tempo gráfico de trinta minutos usado por todo o diagrama. |
