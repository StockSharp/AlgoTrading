...
- Простая скользящая средняя по цене закрытия — единственный ориентир выхода; стоп-лосса и тейк-профита в схеме нет.
...
- **Выход**: Лонг закрывает кубик изменения позиции в режиме закрытия, как только свеча закроется ниже скользящей средней; шорт закрывается так же, когда свеча закроется выше неё. Защитного стопа нет.
