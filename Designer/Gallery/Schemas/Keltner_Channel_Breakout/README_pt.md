...
- O diagrama usa um canal de período 20 com multiplicador 2 em candles de cinco minutos, para que os rompimentos ocorram em dados comuns.
...
- **Saída**: Não há bloco de saída, stop nem alvo: o rompimento contrário inverte a posição.
