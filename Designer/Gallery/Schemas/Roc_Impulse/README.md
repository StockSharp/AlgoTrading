...
- **Exit**: There is no separate exit block. A position is held until the opposite zero-line cross reverses it, with no fixed or ATR-based stop loss.
