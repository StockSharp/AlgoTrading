...
このダイアグラムはただ一つの数値に支えられています。現在の終値と12本前の終値の差です。差がプラスの間はその期間に価格が押し上げられ、マイナスの間は押し下げられたことを意味し、符号が変わった瞬間にポジションを反転させます。フォルダー名に反して、ダイアグラムが使うのは Momentum（価格の絶対差）であり、率で測る変化率ではありません。
