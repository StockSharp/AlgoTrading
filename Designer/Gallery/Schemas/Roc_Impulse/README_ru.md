...
- **Выход**: Отдельного кубика выхода нет. Позиция держится до противоположного пересечения нуля, которое её и переворачивает; фиксированного или основанного на ATR стоп-лосса нет.
