...
- **Exit**: The first close above the fast SMA closes the long. The closing block sends a market order sized to whatever is open, and there is no stop loss and no take profit.
