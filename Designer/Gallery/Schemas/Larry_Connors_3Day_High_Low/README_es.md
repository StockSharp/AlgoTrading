...
- **Salida**: El primer cierre por encima de la SMA rápida cierra el largo. El bloque de cierre envía una orden a mercado por el tamaño abierto, y no hay stop de pérdidas ni objetivo de beneficio.
