...
Um harami é um candle que cabe inteiro dentro do anterior, sinal de que o lado que acabara de empurrar o mercado ficou sem fôlego. Este diagrama mede a contenção pelas extremidades e não pelos corpos, portanto reconhece um inside bar que ainda muda de cor: o candle anterior foi para um lado e o pequeno candle dentro dele vai para o outro. Essa virada é assumida a partir do zero e entregue a uma média móvel simples.

![schema](schema.svg)

## Visão geral da estratégia

- Dois blocos de padrão de candles carregam padrões próprios: o candle anterior tem uma cor, o atual tem a outra, e sua máxima e sua mínima ficam dentro da faixa anterior.
