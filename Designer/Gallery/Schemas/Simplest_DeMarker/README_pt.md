...
O DeMarker mede o quanto cada candle avança além do anterior, para cima contra para baixo, e devolve um valor entre 0 e 1. Este diagrama não compra o extremo, e sim a volta a partir dele: uma leitura que sobe de abaixo do nível de sobrevenda até ele compra, e uma que desce de acima do nível de sobrecompra até ele vende. Ele usa candles de cinco minutos, e a verificação da posição impede uma segunda entrada no mesmo sentido.
