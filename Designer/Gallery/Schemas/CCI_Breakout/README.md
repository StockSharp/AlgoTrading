...
- The diagram works on five-minute candles to match the packaged sample history.
...
- **Exit**: There is no separate exit, stop loss or take profit: the strategy stays in the market and the opposite breakout both closes the running trade and opens the new one.
...
- Two comparison blocks per side test the current and the previous reading against the same level constant, forming the breakout condition.
