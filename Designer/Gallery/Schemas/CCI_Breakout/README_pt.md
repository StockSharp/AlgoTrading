...
- O diagrama trabalha em candles de cinco minutos, de acordo com o histórico de amostra incluído.
...
- **Saída**: Não há saída própria, stop loss nem take profit: a estratégia permanece no mercado e o rompimento contrário encerra a operação atual e abre a nova.
...
- Dois blocos de comparação por lado testam a leitura atual e a anterior contra a mesma constante de nível, formando a condição de rompimento.
