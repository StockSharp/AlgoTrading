...
- El diagrama trabaja con velas de cinco minutos para ajustarse al histórico de muestra incluido.
...
- **Salida**: No hay salida propia, stop loss ni take profit: la estrategia permanece en mercado y la ruptura contraria cierra la operación en curso y abre la nueva.
...
- Dos bloques de comparación por lado contrastan la lectura actual y la anterior con la misma constante de nivel, formando la condición de ruptura.
