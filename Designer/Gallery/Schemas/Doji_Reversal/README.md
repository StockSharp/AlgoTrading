...
- Writing the test as a multiplication rather than a division handles a candle whose high equals its low: the comparison becomes zero against zero and no doji is reported.
...
- **Exit**: A long is closed by a position modify block in close mode once a candle closes below the moving average; a short is closed once a candle closes above it. The diagram has neither a stop loss nor a take profit.
