# Diretório de Exemplos de Estratégias do Designer
[English](README.md) | [Русский](README_ru.md) | [中文](README_zh.md) | [Español](README_es.md) | [Deutsch](README_de.md) | [日本語](README_ja.md)

Bem-vindo ao Diretório de Exemplos de Estratégias do [Designer](https://stocksharp.com/pt/store/strategy-designer/). Esta pasta contém uma coleção de exemplos de estratégias de trading especificamente desenvolvidos para uso com o programa Designer, um ambiente visual e baseado em código dentro da plataforma StockSharp. Esses exemplos são fornecidos nos formatos esquemático e de código C# para atender a diferentes estilos de desenvolvimento e aprendizado.
...
Se você desenvolveu uma estratégia ou tem uma melhoria para um exemplo existente que acredita que beneficiaria outros, sinta-se à vontade para contribuir:

- **Fork e Clone**: Faça um fork deste repositório e clone-o na sua máquina local.
- **Adicione seu Exemplo**: Adicione seu arquivo esquemático ou C# à pasta correspondente com um nome descritivo.
- **Documente sua Estratégia**: Forneça um README.md ou comentários no seu código para explicar a lógica, o uso e quaisquer detalhes pertinentes sobre sua estratégia.
- **Crie um Pull Request**: Envie um pull request com uma descrição detalhada da sua estratégia e como ela contribui para o aprendizado ou a funcionalidade das estratégias do Designer.

## Suporte e Discussão

Se você encontrar algum problema ou tiver dúvidas sobre qualquer um dos exemplos, abra um issue neste repositório. Além disso, para discussões gerais ou para buscar conselhos da comunidade, visite os fóruns ou canais da comunidade StockSharp.

Obrigado por explorar o Diretório de Exemplos de Estratégias do Designer. Esperamos que esses recursos aprimorem o desenvolvimento das suas estratégias de trading e o incentivem a se engajar com a comunidade StockSharp.
