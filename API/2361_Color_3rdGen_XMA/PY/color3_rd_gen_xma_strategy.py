...
class color3_rd_gen_xma_strategy(Strategy):
    def __init__(self):
        super(color3_rd_gen_xma_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(color3_rd_gen_xma_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._is_first = True

    def OnStarted(self, time):
        super(color3_rd_gen_xma_strategy, self).OnStarted(time)
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._is_first = True
    ...
    def CreateClone(self):
        return color3_rd_gen_xma_strategy()
