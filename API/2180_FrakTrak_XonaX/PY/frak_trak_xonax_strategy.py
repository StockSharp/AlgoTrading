...
class frak_trak_xonax_strategy(Strategy):
    def __init__(self):
        super(frak_trak_xonax_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(frak_trak_xonax_strategy, self).OnReseted()
    ...
    def OnStarted(self, time):
        super(frak_trak_xonax_strategy, self).OnStarted(time)
    ...
    def process_candle(self, candle):
        ...
        if self._h1 == 0.0 or self._l1 == 0.0:
            return

        # Detect fractals (bar 3 is the middle)
        if (self._h3 > self._h1 and self._h3 > self._h2 and
                self._h3 > self._h4 and self._h3 > self._h5):
            self._up_fractal = self._h3

        if (self._l3 < self._l1 and self._l3 < self._l2 and
    ...
    def CreateClone(self):
        return frak_trak_xonax_strategy()
