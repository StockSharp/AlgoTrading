...
class funamental_and_financials_strategy(Strategy):
    """
    FunamentalAndFinancials: EMA crossover strategy.
    Buys when fast EMA crosses above slow EMA, sells on reverse.
    """

    def __init__(self):
        super(funamental_and_financials_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(funamental_and_financials_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0

    def OnStarted2(self, time):
        super(funamental_and_financials_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return funamental_and_financials_strategy()
