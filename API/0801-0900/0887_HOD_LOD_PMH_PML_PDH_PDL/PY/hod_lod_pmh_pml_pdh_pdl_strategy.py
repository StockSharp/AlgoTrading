...
class hod_lod_pmh_pml_pdh_pdl_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(hod_lod_pmh_pml_pdh_pdl_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(hod_lod_pmh_pml_pdh_pdl_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0

    def OnStarted2(self, time):
        super(hod_lod_pmh_pml_pdh_pdl_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return hod_lod_pmh_pml_pdh_pdl_strategy()
