...
class grid_like_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(grid_like_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(grid_like_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0

    def OnStarted2(self, time):
        super(grid_like_strategy, self).OnStarted2(time)
