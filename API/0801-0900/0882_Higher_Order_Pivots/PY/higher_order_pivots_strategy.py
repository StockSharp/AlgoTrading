...
class higher_order_pivots_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(higher_order_pivots_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(higher_order_pivots_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0

    def OnStarted2(self, time):
        super(higher_order_pivots_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return higher_order_pivots_strategy()
