...
class golden_transform_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(golden_transform_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(golden_transform_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0

    def OnStarted2(self, time):
        super(golden_transform_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return golden_transform_strategy()
