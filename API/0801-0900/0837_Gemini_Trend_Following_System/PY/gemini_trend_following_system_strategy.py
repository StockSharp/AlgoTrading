...
class gemini_trend_following_system_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(gemini_trend_following_system_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(gemini_trend_following_system_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0

    def OnStarted2(self, time):
        super(gemini_trend_following_system_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return gemini_trend_following_system_strategy()
