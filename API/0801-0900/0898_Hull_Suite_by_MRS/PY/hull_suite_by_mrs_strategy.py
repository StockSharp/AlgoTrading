...
class hull_suite_by_mrs_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(hull_suite_by_mrs_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(hull_suite_by_mrs_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0

    def OnStarted2(self, time):
        super(hull_suite_by_mrs_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return hull_suite_by_mrs_strategy()
