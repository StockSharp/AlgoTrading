...
class friday_bond_short_strategy(Strategy):
    """
    FridayBondShort: EMA crossover strategy.
    Buys when fast EMA crosses above slow EMA, sells on reverse.
    """

    def __init__(self):
        super(friday_bond_short_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(friday_bond_short_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0

    def OnStarted2(self, time):
        super(friday_bond_short_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return friday_bond_short_strategy()
