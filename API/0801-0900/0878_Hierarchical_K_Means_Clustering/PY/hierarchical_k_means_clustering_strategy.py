...
class hierarchical_k_means_clustering_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(hierarchical_k_means_clustering_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(hierarchical_k_means_clustering_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0

    def OnStarted2(self, time):
        super(hierarchical_k_means_clustering_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return hierarchical_k_means_clustering_strategy()
