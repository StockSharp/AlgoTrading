...
class gradient_trend_filter_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(gradient_trend_filter_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(gradient_trend_filter_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0

    def OnStarted2(self, time):
        super(gradient_trend_filter_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return gradient_trend_filter_strategy()
