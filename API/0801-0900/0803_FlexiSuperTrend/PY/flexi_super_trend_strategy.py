...
class flexi_super_trend_strategy(Strategy):
    """
    FlexiSuperTrend: EMA crossover strategy.
    Buys when fast EMA crosses above slow EMA, sells on reverse.
    """

    def __init__(self):
        super(flexi_super_trend_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(flexi_super_trend_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0

    def OnStarted2(self, time):
        super(flexi_super_trend_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return flexi_super_trend_strategy()
