...
class uptrick_x_pine_indicators_z_score_flow_strategy(Strategy):
    def __init__(self):
        ...
        self._z_sell_level = self.Param("ZSellLevel", 2) \
    ...
    @property
    def z_score_period(self):
        return self._z_score_period.Value

    @property
    def z_buy_level(self):
        return self._z_buy_level.Value

    @property
    def z_sell_level(self):
        return self._z_sell_level.Value

    def OnReseted(self):
        super(uptrick_x_pine_indicators_z_score_flow_strategy, self).OnReseted()
        self._prev_rsi = 0.0
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._cooldown = 0
    ...
    def OnStarted2(self, time):
        super(uptrick_x_pine_indicators_z_score_flow_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return uptrick_x_pine_indicators_z_score_flow_strategy()
