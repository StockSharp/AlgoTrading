...
class htf_candles_lib_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(htf_candles_lib_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(htf_candles_lib_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0

    def OnStarted2(self, time):
        super(htf_candles_lib_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return htf_candles_lib_strategy()
