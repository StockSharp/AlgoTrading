...
class trade_entry_detector_wick_to_body_ratio_strategy(Strategy):
    def __init__(self):
        super(trade_entry_detector_wick_to_body_ratio_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(trade_entry_detector_wick_to_body_ratio_strategy, self).OnReseted()
        self._prev_f = 0.0
        self._prev_s = 0.0
        self._init = False
        self._last_signal_ticks = 0
    ...
    def OnStarted2(self, time):
        super(trade_entry_detector_wick_to_body_ratio_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return trade_entry_detector_wick_to_body_ratio_strategy()
