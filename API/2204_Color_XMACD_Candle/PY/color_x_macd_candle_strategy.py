...
class color_x_macd_candle_strategy(Strategy):
    def __init__(self):
        super(color_x_macd_candle_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(color_x_macd_candle_strategy, self).OnReseted()
        self._signal_ma = None
        self._prev_hist = None
        self._prev_prev_hist = None

    def OnStarted(self, time):
        super(color_x_macd_candle_strategy, self).OnStarted(time)
    ...
    def CreateClone(self):
        return color_x_macd_candle_strategy()
