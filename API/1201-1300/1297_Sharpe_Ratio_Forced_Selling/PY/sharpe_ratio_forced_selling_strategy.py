...
class sharpe_ratio_forced_selling_strategy(Strategy):
    def __init__(self):
        super(sharpe_ratio_forced_selling_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(sharpe_ratio_forced_selling_strategy, self).OnReseted()
        self._prev_f = 0.0
        self._prev_s = 0.0
        self._init = False
        self._last_signal_ticks = 0
    ...
    def OnStarted2(self, time):
        super(sharpe_ratio_forced_selling_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return sharpe_ratio_forced_selling_strategy()
