...
class sp100_option_expiration_week_strategy(Strategy):
    def __init__(self):
        super(sp100_option_expiration_week_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(sp100_option_expiration_week_strategy, self).OnReseted()
        self._prev_f = 0.0
        self._prev_s = 0.0
        self._init = False
        self._last_signal_ticks = 0
    ...
    def OnStarted2(self, time):
        super(sp100_option_expiration_week_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return sp100_option_expiration_week_strategy()
