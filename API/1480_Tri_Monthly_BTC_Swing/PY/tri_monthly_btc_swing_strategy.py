...
class tri_monthly_btc_swing_strategy(Strategy):
    def __init__(self):
        super(tri_monthly_btc_swing_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(tri_monthly_btc_swing_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return tri_monthly_btc_swing_strategy()
