...
class pairs_trading_volatility_filter_strategy(Strategy):
    ...
    def _process_security1_candle(self, candle, atr_value):
        ...
        atr_sma_value = float(process_float(self._atr_sma, atr_value, candle.ServerTime, candle.State == CandleStates.Finished))
    ...
    def _process_security2_candle(self, candle):
        ...
        spread_sma_value = float(process_float(self._spread_sma, self._current_spread, candle.ServerTime, candle.State == CandleStates.Finished))
        std_dev_value = float(process_float(self._std_dev, self._current_spread, candle.ServerTime, candle.State == CandleStates.Finished))
