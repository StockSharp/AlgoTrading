...
class fine_tune_gann_laplace_vzo_strategy(Strategy):
    """
    FineTuneGannLaplaceVzo: EMA crossover strategy.
    Buys when fast EMA crosses above slow EMA, sells on reverse.
    """

    def __init__(self):
        super(fine_tune_gann_laplace_vzo_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(fine_tune_gann_laplace_vzo_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0

    def OnStarted2(self, time):
        super(fine_tune_gann_laplace_vzo_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return fine_tune_gann_laplace_vzo_strategy()
