...
class i_cai_strategy(Strategy):
    def __init__(self):
        super(i_cai_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(i_cai_strategy, self).OnReseted()
        self._ma = None
        self._std = None
        self._prev_icai = None
        self._prev_slope = None
    ...
    def OnStarted(self, time):
        super(i_cai_strategy, self).OnStarted(time)
        self._prev_icai = None
        self._prev_slope = None
