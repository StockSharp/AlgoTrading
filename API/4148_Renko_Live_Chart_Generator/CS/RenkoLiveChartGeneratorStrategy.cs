...
/// </summary>
public class RenkoLiveChartGeneratorStrategy : Strategy
{
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="RenkoLiveChartGeneratorStrategy"/> class.
	/// </summary>
	public RenkoLiveChartGeneratorStrategy()
	{
