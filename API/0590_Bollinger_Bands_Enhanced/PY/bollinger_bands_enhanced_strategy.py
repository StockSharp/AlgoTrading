...
class bollinger_bands_enhanced_strategy(Strategy):
    def __init__(self):
        super(bollinger_bands_enhanced_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(bollinger_bands_enhanced_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0

    def OnStarted2(self, time):
        super(bollinger_bands_enhanced_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return bollinger_bands_enhanced_strategy()
