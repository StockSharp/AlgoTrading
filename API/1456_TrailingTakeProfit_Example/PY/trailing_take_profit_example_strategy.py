...
class trailing_take_profit_example_strategy(Strategy):
    def __init__(self):
        super(trailing_take_profit_example_strategy, self).__init__()
    ...
    def CreateClone(self):
        return trailing_take_profit_example_strategy()
