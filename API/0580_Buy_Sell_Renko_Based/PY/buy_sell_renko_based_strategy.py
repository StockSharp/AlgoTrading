...
class buy_sell_renko_based_strategy(Strategy):
    """
    Strategy that trades on candle direction changes using EMA crossover.
    Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(buy_sell_renko_based_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(buy_sell_renko_based_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0

    def OnStarted2(self, time):
        super(buy_sell_renko_based_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return buy_sell_renko_based_strategy()
