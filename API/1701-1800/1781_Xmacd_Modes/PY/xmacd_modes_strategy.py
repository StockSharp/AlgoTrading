...
class xmacd_modes_strategy(Strategy):
    def __init__(self):
        super(xmacd_modes_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(xmacd_modes_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._has_prev = False

    def OnStarted2(self, time):
        super(xmacd_modes_strategy, self).OnStarted2(time)
