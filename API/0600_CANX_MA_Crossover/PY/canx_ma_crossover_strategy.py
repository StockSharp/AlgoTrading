...
class canx_ma_crossover_strategy(Strategy):
    """
    CANX MA Crossover strategy using EMA crossover for trend timing.
    Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(canx_ma_crossover_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(canx_ma_crossover_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0

    def OnStarted2(self, time):
        super(canx_ma_crossover_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return canx_ma_crossover_strategy()
