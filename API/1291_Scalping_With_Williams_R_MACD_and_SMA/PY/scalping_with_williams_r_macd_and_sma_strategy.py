...
class scalping_with_williams_r_macd_and_sma_strategy(Strategy):
    def __init__(self):
        super(scalping_with_williams_r_macd_and_sma_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(scalping_with_williams_r_macd_and_sma_strategy, self).OnReseted()
        self._prev_f = 0.0
        self._prev_s = 0.0
        self._init = False
        self._last_signal_ticks = 0
    ...
    def OnStarted2(self, time):
        super(scalping_with_williams_r_macd_and_sma_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return scalping_with_williams_r_macd_and_sma_strategy()
