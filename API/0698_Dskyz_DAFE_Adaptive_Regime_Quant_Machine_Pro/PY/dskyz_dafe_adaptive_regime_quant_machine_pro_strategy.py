...
class dskyz_dafe_adaptive_regime_quant_machine_pro_strategy(Strategy):
    """
    Dskyz DAFE Adaptive Regime Quant Machine Pro strategy using EMA crossover.
    Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(dskyz_dafe_adaptive_regime_quant_machine_pro_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(dskyz_dafe_adaptive_regime_quant_machine_pro_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0
    def OnStarted2(self, time):
        super(dskyz_dafe_adaptive_regime_quant_machine_pro_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return dskyz_dafe_adaptive_regime_quant_machine_pro_strategy()
