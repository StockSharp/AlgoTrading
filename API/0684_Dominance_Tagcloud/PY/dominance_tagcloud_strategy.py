...
class dominance_tagcloud_strategy(Strategy):
    """
    Dominance Tagcloud strategy using EMA crossover.
    Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(dominance_tagcloud_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(dominance_tagcloud_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return dominance_tagcloud_strategy()
