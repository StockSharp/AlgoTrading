...
class us30_daily_breakout_strategy(Strategy):
    def __init__(self):
        super(us30_daily_breakout_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(us30_daily_breakout_strategy, self).OnReseted()
        self._prev_rsi = 0.0
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._cooldown = 0
    ...
    def OnStarted2(self, time):
        super(us30_daily_breakout_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return us30_daily_breakout_strategy()
