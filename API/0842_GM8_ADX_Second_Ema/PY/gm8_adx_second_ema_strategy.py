...
class gm8_adx_second_ema_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(gm8_adx_second_ema_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(gm8_adx_second_ema_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0

    def OnStarted2(self, time):
        super(gm8_adx_second_ema_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return gm8_adx_second_ema_strategy()
