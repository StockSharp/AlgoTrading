...
class fine_tuning_ma_candle_duplex_strategy(Strategy):
    """
    FineTuning MA Candle Duplex: WMA crossover with SL/TP and cooldown.
    Buys when fast WMA crosses above slow WMA, sells on reverse.
    """

    def __init__(self):
        super(fine_tuning_ma_candle_duplex_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(fine_tuning_ma_candle_duplex_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._entry_price = 0.0
        self._cooldown = 0
    ...
    def OnStarted2(self, time):
        super(fine_tuning_ma_candle_duplex_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return fine_tuning_ma_candle_duplex_strategy()
