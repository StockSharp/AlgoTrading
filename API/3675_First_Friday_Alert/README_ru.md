...
| --- | --- | --- | --- |
| `CandleType` | `DataType` | Дневной таймфрейм (`TimeSpan.FromMinutes(5).TimeFrame()`) | Свечи, которые анализируются на предмет первого пятничного бара. Значение можно изменить, если поставщик данных использует иной тип дневных баров. |
