...
class turn_of_the_month_honestcowboy_strategy(Strategy):
    def __init__(self):
        super(turn_of_the_month_honestcowboy_strategy, self).__init__()
        self._days_before_end = self.Param("DaysBeforeEnd", 5) \
            .SetDisplay("Days Before End", "Days before month end to begin entries", "Strategy")
        self._days_after_start = self.Param("DaysAfterStart", TimeSpan.FromMinutes(5)) \
    ...
    @property
    def days_before_end(self):
        return self._days_before_end.Value

    @property
    def days_after_start(self):
        return self._days_after_start.Value
    ...
    def OnReseted(self):
        super(turn_of_the_month_honestcowboy_strategy, self).OnReseted()
        self._prev_rsi = 0.0
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._cooldown = 0
    ...
    def OnStarted2(self, time):
        super(turn_of_the_month_honestcowboy_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return turn_of_the_month_honestcowboy_strategy()
