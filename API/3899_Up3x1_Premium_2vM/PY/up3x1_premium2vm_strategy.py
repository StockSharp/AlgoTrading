...
class up3x1_premium2vm_strategy(Strategy):
    def __init__(self):
        super(up3x1_premium2vm_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(up3x1_premium2vm_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._has_prev = False
        self._cooldown_remaining = 0
    ...
    def OnStarted(self, time):
        super(up3x1_premium2vm_strategy, self).OnStarted(time)
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._has_prev = False
        self._cooldown_remaining = 0
    ...
    def CreateClone(self):
        return up3x1_premium2vm_strategy()
