...
class omzdwwi_pending_manager_strategy(Strategy):
    ...
    def OnStarted(self, time):
        super(omzdwwi_pending_manager_strategy, self).OnStarted(time)
        ...
        subscription.Bind(self._rsi, self._sma, self._process_candle).Start()
    ...
    def CreateClone(self):
        return omzdwwi_pending_manager_strategy()
