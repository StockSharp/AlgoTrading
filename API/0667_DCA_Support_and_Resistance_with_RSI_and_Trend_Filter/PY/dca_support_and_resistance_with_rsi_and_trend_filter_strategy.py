...
class dca_support_and_resistance_with_rsi_and_trend_filter_strategy(Strategy):
    """
    DCA Support and Resistance with RSI and Trend Filter strategy using EMA crossover.
    ...
    def OnStarted(self, time):
        super(dca_support_and_resistance_with_rsi_and_trend_filter_strategy, self).OnStarted(time)
