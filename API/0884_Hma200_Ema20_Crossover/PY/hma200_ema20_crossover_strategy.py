...
class hma200_ema20_crossover_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(hma200_ema20_crossover_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(hma200_ema20_crossover_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0

    def OnStarted2(self, time):
        super(hma200_ema20_crossover_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return hma200_ema20_crossover_strategy()
