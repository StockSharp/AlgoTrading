...
class dynamic_breakout_master_strategy(Strategy):
    def __init__(self):
        super(dynamic_breakout_master_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(dynamic_breakout_master_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0

    def OnStarted2(self, time):
        super(dynamic_breakout_master_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return dynamic_breakout_master_strategy()
