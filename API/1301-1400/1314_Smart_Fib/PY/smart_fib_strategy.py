...
class smart_fib_strategy(Strategy):
    def __init__(self):
        super(smart_fib_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(smart_fib_strategy, self).OnReseted()
        self._prev_f = 0.0
        self._prev_s = 0.0
        self._init = False
        self._last_signal_ticks = 0
    ...
    def OnStarted2(self, time):
        super(smart_fib_strategy, self).OnStarted2(time)
