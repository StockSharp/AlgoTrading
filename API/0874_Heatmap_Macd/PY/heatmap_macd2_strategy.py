...
class heatmap_macd2_strategy(Strategy):
    """
    ...
    def OnReseted(self):
        super(heatmap_macd2_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0

    def OnStarted2(self, time):
        super(heatmap_macd2_strategy, self).OnStarted2(time)
