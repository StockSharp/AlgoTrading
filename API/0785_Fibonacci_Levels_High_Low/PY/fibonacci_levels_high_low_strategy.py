...
class fibonacci_levels_high_low_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(fibonacci_levels_high_low_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(fibonacci_levels_high_low_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0
    def OnStarted2(self, time):
        super(fibonacci_levels_high_low_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return fibonacci_levels_high_low_strategy()
