...
Implementation of strategy #161 - MACD + CCI. Buy when MACD is above
Signal line and CCI is below -100 (oversold). Sell when MACD is below
Signal line and CCI is above 100 (overbought).
