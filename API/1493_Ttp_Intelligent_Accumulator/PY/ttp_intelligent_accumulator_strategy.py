...
class ttp_intelligent_accumulator_strategy(Strategy):
    ...
    def OnReseted(self):
        super(ttp_intelligent_accumulator_strategy, self).OnReseted()
        self._prev_rsi = 0.0
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._cooldown = 0
    ...
    def OnStarted2(self, time):
        super(ttp_intelligent_accumulator_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return ttp_intelligent_accumulator_strategy()
