...
Версия для StockSharp повторяет исходную логику, но использует высокоуровневые возможности API: подписку на свечи, автоматическую установку защитных заявок и систему параметров. Реализации доступны на C# и Python.
