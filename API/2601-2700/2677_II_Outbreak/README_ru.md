...
* Конвертация выполнена с использованием высокоуровневого API StockSharp (`SubscribeCandles` + `Bind`). Все комментарии в коде оставлены на английском языке. Реализации доступны на C# и Python.
