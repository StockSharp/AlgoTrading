...
class cbc_with_trend_confirmation_and_separate_stop_loss_strategy(Strategy):
    """
    CBC with trend confirmation and separate stop loss strategy using EMA crossover.
    ...
    def OnStarted(self, time):
        super(cbc_with_trend_confirmation_and_separate_stop_loss_strategy, self).OnStarted(time)
