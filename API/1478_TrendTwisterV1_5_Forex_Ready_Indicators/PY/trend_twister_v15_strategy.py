...
class trend_twister_v15_strategy(Strategy):
    def __init__(self):
        super(trend_twister_v15_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(trend_twister_v15_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return trend_twister_v15_strategy()
