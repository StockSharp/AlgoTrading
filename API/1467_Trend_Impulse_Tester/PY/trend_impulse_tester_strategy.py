...
class trend_impulse_tester_strategy(Strategy):
    def __init__(self):
        super(trend_impulse_tester_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(trend_impulse_tester_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return trend_impulse_tester_strategy()
