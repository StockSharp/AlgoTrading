...
class uhl_ma_crossover_system_strategy(Strategy):
    def __init__(self):
        super(uhl_ma_crossover_system_strategy, self).__init__()
        self._length = self.Param("Length", 50) \
            .SetDisplay("Length", "Lookback length", "General")
        self._multiplier = self.Param("Multiplier", TimeSpan.FromMinutes(5)) \
    ...
    def OnReseted(self):
        super(uhl_ma_crossover_system_strategy, self).OnReseted()
        self._prev_rsi = 0.0
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._cooldown = 0
    ...
    def OnStarted2(self, time):
        super(uhl_ma_crossover_system_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return uhl_ma_crossover_system_strategy()
