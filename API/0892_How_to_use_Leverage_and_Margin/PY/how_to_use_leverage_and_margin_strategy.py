...
class how_to_use_leverage_and_margin_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(how_to_use_leverage_and_margin_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(how_to_use_leverage_and_margin_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0

    def OnStarted2(self, time):
        super(how_to_use_leverage_and_margin_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return how_to_use_leverage_and_margin_strategy()
