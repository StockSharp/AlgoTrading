...
class energy_advanced_policy_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(energy_advanced_policy_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(energy_advanced_policy_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0
    def OnStarted2(self, time):
        super(energy_advanced_policy_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return energy_advanced_policy_strategy()
