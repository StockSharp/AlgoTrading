...
class trend_magic_with_ema_sma_and_auto_trading_strategy(Strategy):
    def __init__(self):
        super(trend_magic_with_ema_sma_and_auto_trading_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(trend_magic_with_ema_sma_and_auto_trading_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return trend_magic_with_ema_sma_and_auto_trading_strategy()
