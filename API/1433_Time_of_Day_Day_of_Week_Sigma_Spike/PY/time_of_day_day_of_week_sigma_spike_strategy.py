...
class time_of_day_day_of_week_sigma_spike_strategy(Strategy):
    def __init__(self):
        super(time_of_day_day_of_week_sigma_spike_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(time_of_day_day_of_week_sigma_spike_strategy, self).OnReseted()
        self._prev_f = 0.0
        self._prev_s = 0.0
        self._init = False
        self._last_signal_ticks = 0
    ...
    def OnStarted2(self, time):
        super(time_of_day_day_of_week_sigma_spike_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return time_of_day_day_of_week_sigma_spike_strategy()
