...
class fon60dk_strategy(Strategy):
    """
    Fon60Dk: EMA crossover strategy.
    Buys when fast EMA crosses above slow EMA, sells on reverse.
    """

    def __init__(self):
        super(fon60dk_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(fon60dk_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0

    def OnStarted2(self, time):
        super(fon60dk_strategy, self).OnStarted2(time)
