...
class daily_bollinger_band_strategy(Strategy):
    def __init__(self):
        super(daily_bollinger_band_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(daily_bollinger_band_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0

    def OnStarted2(self, time):
        super(daily_bollinger_band_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return daily_bollinger_band_strategy()
