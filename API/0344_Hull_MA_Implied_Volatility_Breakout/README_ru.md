# Hull MA и пробой подразумеваемой волатильности Стратегия **Hull MA Implied Volatility Breakout** использует Hull MA для поиска пробоев подразумеваемой волатильности.
