...
class enhanced_range_filter_atr_tp_sl_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(enhanced_range_filter_atr_tp_sl_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(enhanced_range_filter_atr_tp_sl_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0
    def OnStarted2(self, time):
        super(enhanced_range_filter_atr_tp_sl_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return enhanced_range_filter_atr_tp_sl_strategy()
