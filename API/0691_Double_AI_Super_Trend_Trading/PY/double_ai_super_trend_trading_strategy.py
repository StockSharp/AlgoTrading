...
class double_ai_super_trend_trading_strategy(Strategy):
    """
    Double AI Super Trend Trading strategy using EMA crossover.
    Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(double_ai_super_trend_trading_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(double_ai_super_trend_trading_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0
    def OnStarted2(self, time):
        super(double_ai_super_trend_trading_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return double_ai_super_trend_trading_strategy()
