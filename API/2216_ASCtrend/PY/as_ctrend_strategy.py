...
class as_ctrend_strategy(Strategy):
    def __init__(self):
        super(as_ctrend_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(as_ctrend_strategy, self).OnReseted()
        self._was_oversold = False
        self._was_overbought = False

    def OnStarted(self, time):
        super(as_ctrend_strategy, self).OnStarted(time)
        wpr = WilliamsR()
