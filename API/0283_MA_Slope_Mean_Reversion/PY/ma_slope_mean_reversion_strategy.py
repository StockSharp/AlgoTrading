...
class ma_slope_mean_reversion_strategy(Strategy):
    ...
    def OnStarted2(self, time):
        super(ma_slope_mean_reversion_strategy, self).OnStarted2(time)
        ...
        self._ma.Length = int(self._ma_period.Value)
    ...
    def _process_candle(self, candle, ma_value):
        ...
        slope = mv - self._previous_ma_value
        self._previous_ma_value = mv
