...
class trend_following_moving_averages_strategy(Strategy):
    def __init__(self):
        super(trend_following_moving_averages_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(trend_following_moving_averages_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return trend_following_moving_averages_strategy()
