...
/// </summary>
public class TrailingStopPointsStrategy : Strategy
{
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="TrailingStopPointsStrategy"/> class.
	/// </summary>
	public TrailingStopPointsStrategy()
	{
