...
class coensio_swing_trader_strategy(Strategy):
    def __init__(self):
        super(coensio_swing_trader_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(coensio_swing_trader_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._has_prev = False

    def OnStarted2(self, time):
        super(coensio_swing_trader_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return coensio_swing_trader_strategy()
