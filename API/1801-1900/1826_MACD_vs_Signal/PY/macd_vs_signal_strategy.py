...
class macd_vs_signal_strategy(Strategy):
    def __init__(self):
        super(macd_vs_signal_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(macd_vs_signal_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._has_prev = False

    def OnStarted2(self, time):
        super(macd_vs_signal_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return macd_vs_signal_strategy()
