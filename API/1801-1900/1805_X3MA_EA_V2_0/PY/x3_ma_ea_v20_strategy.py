...
class x3_ma_ea_v20_strategy(Strategy):
    def __init__(self):
        super(x3_ma_ea_v20_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(x3_ma_ea_v20_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_mid = 0.0
        self._has_prev = False
    def OnStarted2(self, time):
        super(x3_ma_ea_v20_strategy, self).OnStarted2(time)
