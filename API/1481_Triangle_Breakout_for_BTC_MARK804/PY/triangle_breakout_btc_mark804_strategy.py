...
class triangle_breakout_btc_mark804_strategy(Strategy):
    def __init__(self):
        super(triangle_breakout_btc_mark804_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(triangle_breakout_btc_mark804_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return triangle_breakout_btc_mark804_strategy()
