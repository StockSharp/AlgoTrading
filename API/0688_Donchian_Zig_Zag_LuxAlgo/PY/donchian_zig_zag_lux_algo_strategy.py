...
class donchian_zig_zag_lux_algo_strategy(Strategy):
    """
    Donchian Zig Zag LuxAlgo strategy using EMA crossover.
    Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(donchian_zig_zag_lux_algo_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(donchian_zig_zag_lux_algo_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return donchian_zig_zag_lux_algo_strategy()
