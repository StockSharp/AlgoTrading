...
class ultimate_template_strategy(Strategy):
    def __init__(self):
    ...
    def OnReseted(self):
        super(ultimate_template_strategy, self).OnReseted()
        self._prev_rsi = 0.0
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._cooldown = 0
    ...
    def OnStarted(self, time):
        super(ultimate_template_strategy, self).OnStarted(time)
    ...
    def CreateClone(self):
        return ultimate_template_strategy()
