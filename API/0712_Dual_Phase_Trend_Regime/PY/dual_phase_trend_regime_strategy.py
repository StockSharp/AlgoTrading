...
class dual_phase_trend_regime_strategy(Strategy):
    """
    Dual Phase Trend Regime strategy using EMA crossover.
    Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(dual_phase_trend_regime_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(dual_phase_trend_regime_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0
    def OnStarted2(self, time):
        super(dual_phase_trend_regime_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return dual_phase_trend_regime_strategy()
