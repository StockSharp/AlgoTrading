...
class gold_friday_anomaly_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(gold_friday_anomaly_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(gold_friday_anomaly_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0

    def OnStarted2(self, time):
        super(gold_friday_anomaly_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return gold_friday_anomaly_strategy()
