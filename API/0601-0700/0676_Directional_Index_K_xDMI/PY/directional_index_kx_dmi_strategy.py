...
class directional_index_kx_dmi_strategy(Strategy):
    """
    Directional Index KxDMI strategy using EMA crossover.
    Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(directional_index_kx_dmi_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(directional_index_kx_dmi_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return directional_index_kx_dmi_strategy()
