...
class covid_statistics_tracker_strategy(Strategy):
    """
    EMA crossover strategy. Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(covid_statistics_tracker_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(covid_statistics_tracker_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0

    def OnStarted2(self, time):
        super(covid_statistics_tracker_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return covid_statistics_tracker_strategy()
