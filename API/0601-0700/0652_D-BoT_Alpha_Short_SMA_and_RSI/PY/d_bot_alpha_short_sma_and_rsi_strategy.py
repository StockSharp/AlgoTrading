...
class d_bot_alpha_short_sma_and_rsi_strategy(Strategy):
    def __init__(self):
        super(d_bot_alpha_short_sma_and_rsi_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(d_bot_alpha_short_sma_and_rsi_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0

    def OnStarted2(self, time):
        super(d_bot_alpha_short_sma_and_rsi_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return d_bot_alpha_short_sma_and_rsi_strategy()
