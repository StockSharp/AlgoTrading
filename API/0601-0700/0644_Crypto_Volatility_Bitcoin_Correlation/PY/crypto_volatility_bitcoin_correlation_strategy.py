...
class crypto_volatility_bitcoin_correlation_strategy(Strategy):
    """
    EMA crossover strategy. Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(crypto_volatility_bitcoin_correlation_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(crypto_volatility_bitcoin_correlation_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0

    def OnStarted2(self, time):
        super(crypto_volatility_bitcoin_correlation_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return crypto_volatility_bitcoin_correlation_strategy()
