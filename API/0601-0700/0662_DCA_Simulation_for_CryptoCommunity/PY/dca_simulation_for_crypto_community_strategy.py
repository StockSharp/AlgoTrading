...
class dca_simulation_for_crypto_community_strategy(Strategy):
    """
    DCA Simulation for Crypto Community strategy using EMA crossover.
    Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(dca_simulation_for_crypto_community_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(dca_simulation_for_crypto_community_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return dca_simulation_for_crypto_community_strategy()
