...
class color_gradient_framework_strategy(Strategy):
    def __init__(self):
        super(color_gradient_framework_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(color_gradient_framework_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0

    def OnStarted2(self, time):
        super(color_gradient_framework_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return color_gradient_framework_strategy()
