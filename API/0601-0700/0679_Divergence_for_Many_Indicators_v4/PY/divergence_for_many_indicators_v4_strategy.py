...
class divergence_for_many_indicators_v4_strategy(Strategy):
    """
    Divergence for Many Indicators V4 strategy using EMA crossover.
    Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(divergence_for_many_indicators_v4_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(divergence_for_many_indicators_v4_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return divergence_for_many_indicators_v4_strategy()
