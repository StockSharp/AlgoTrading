...
class combo_2_20_ema_cci_strategy(Strategy):
    def __init__(self):
        super(combo_2_20_ema_cci_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(combo_2_20_ema_cci_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0

    def OnStarted2(self, time):
        super(combo_2_20_ema_cci_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return combo_2_20_ema_cci_strategy()
