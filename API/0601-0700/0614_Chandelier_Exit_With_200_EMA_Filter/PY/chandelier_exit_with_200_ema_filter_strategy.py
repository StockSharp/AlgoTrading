...
class chandelier_exit_with_200_ema_filter_strategy(Strategy):
    def __init__(self):
        super(chandelier_exit_with_200_ema_filter_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(chandelier_exit_with_200_ema_filter_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0

    def OnStarted2(self, time):
        super(chandelier_exit_with_200_ema_filter_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return chandelier_exit_with_200_ema_filter_strategy()
