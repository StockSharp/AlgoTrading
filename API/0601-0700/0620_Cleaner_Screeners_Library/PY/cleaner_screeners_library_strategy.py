...
class cleaner_screeners_library_strategy(Strategy):
    def __init__(self):
        super(cleaner_screeners_library_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(cleaner_screeners_library_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0

    def OnStarted2(self, time):
        super(cleaner_screeners_library_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return cleaner_screeners_library_strategy()
