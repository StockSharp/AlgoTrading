...
class dca_with_hedging_strategy(Strategy):
    """
    DCA with Hedging strategy using EMA crossover.
    Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(dca_with_hedging_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(dca_with_hedging_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return dca_with_hedging_strategy()
