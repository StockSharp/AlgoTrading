...
class daily_performance_analysis_strategy(Strategy):
    """
    Daily Performance Analysis strategy using EMA crossover.
    Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(daily_performance_analysis_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(daily_performance_analysis_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return daily_performance_analysis_strategy()
