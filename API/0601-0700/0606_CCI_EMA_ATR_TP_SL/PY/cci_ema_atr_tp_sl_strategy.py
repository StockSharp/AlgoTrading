...
class cci_ema_atr_tp_sl_strategy(Strategy):
    def __init__(self):
        super(cci_ema_atr_tp_sl_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(cci_ema_atr_tp_sl_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0

    def OnStarted2(self, time):
        super(cci_ema_atr_tp_sl_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return cci_ema_atr_tp_sl_strategy()
