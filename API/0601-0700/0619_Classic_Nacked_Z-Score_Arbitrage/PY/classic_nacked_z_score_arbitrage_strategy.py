...
class classic_nacked_z_score_arbitrage_strategy(Strategy):
    def __init__(self):
        super(classic_nacked_z_score_arbitrage_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(classic_nacked_z_score_arbitrage_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0

    def OnStarted2(self, time):
        super(classic_nacked_z_score_arbitrage_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return classic_nacked_z_score_arbitrage_strategy()
