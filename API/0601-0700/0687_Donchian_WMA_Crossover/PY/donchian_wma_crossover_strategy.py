...
class donchian_wma_crossover_strategy(Strategy):
    """
    Donchian WMA Crossover strategy using EMA crossover.
    Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(donchian_wma_crossover_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(donchian_wma_crossover_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return donchian_wma_crossover_strategy()
