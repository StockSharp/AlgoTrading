...
class divergence_indicator_any_oscillator_strategy(Strategy):
    """
    Divergence Indicator Any Oscillator strategy using EMA crossover.
    Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(divergence_indicator_any_oscillator_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(divergence_indicator_any_oscillator_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return divergence_indicator_any_oscillator_strategy()
