...
class daily_breakout_daily_shadow_strategy(Strategy):
    """
    Daily Breakout Daily Shadow strategy using EMA crossover.
    Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(daily_breakout_daily_shadow_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(daily_breakout_daily_shadow_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return daily_breakout_daily_shadow_strategy()
