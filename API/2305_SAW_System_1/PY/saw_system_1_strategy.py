...
class saw_system_1_strategy(Strategy):
    def __init__(self):
        super(saw_system_1_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(saw_system_1_strategy, self).OnReseted()
        self._prev_atr = None
        self._session_open = 0.0
        self._traded = False
        self._current_date = None
    ...
    def OnStarted(self, time):
        super(saw_system_1_strategy, self).OnStarted(time)
        self._prev_atr = None
        self._session_open = 0.0
        self._traded = False
        self._current_date = None
