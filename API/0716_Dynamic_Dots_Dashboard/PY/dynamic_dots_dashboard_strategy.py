...
class dynamic_dots_dashboard_strategy(Strategy):
    """
    Dynamic Dots Dashboard strategy using EMA crossover.
    Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(dynamic_dots_dashboard_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(dynamic_dots_dashboard_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0
    def OnStarted2(self, time):
        super(dynamic_dots_dashboard_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return dynamic_dots_dashboard_strategy()
