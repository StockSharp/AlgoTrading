...
class daily_play_ace_spectrum_strategy(Strategy):
    """
    Daily Play Ace Spectrum strategy using EMA crossover.
    Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(daily_play_ace_spectrum_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(daily_play_ace_spectrum_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return daily_play_ace_spectrum_strategy()
