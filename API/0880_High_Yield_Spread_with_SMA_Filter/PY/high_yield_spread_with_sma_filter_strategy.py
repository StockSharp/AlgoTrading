...
class high_yield_spread_with_sma_filter_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(high_yield_spread_with_sma_filter_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(high_yield_spread_with_sma_filter_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0

    def OnStarted2(self, time):
        super(high_yield_spread_with_sma_filter_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return high_yield_spread_with_sma_filter_strategy()
