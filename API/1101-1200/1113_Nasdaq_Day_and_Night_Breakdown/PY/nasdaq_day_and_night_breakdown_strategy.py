...
class nasdaq_day_and_night_breakdown_strategy(Strategy):
    def __init__(self):
        super(nasdaq_day_and_night_breakdown_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(nasdaq_day_and_night_breakdown_strategy, self).OnReseted()
        self._prev_f = 0
        self._prev_s = 0
        self._init = False
    ...
    def OnStarted2(self, time):
        super(nasdaq_day_and_night_breakdown_strategy, self).OnStarted2(time)
        self._prev_f = 0
        self._prev_s = 0
        self._init = False
        self._last_signal = None
    ...
    def CreateClone(self):
        return nasdaq_day_and_night_breakdown_strategy()
