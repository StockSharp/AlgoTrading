...
class neo_imacd_sl_tp_strategy(Strategy):
    def __init__(self):
        super(neo_imacd_sl_tp_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(neo_imacd_sl_tp_strategy, self).OnReseted()
        self._prev_f = 0
        self._prev_s = 0
        self._init = False
    ...
    def OnStarted2(self, time):
        super(neo_imacd_sl_tp_strategy, self).OnStarted2(time)
        self._prev_f = 0
        self._prev_s = 0
        self._init = False
        self._last_signal = None
    ...
    def CreateClone(self):
        return neo_imacd_sl_tp_strategy()
