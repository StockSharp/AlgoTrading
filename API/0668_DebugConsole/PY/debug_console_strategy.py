...
class debug_console_strategy(Strategy):
    """
    Debug Console strategy using EMA crossover.
    Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(debug_console_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(debug_console_strategy, self).OnStarted2(time)
