...
class ultimate_oscillator_strategy(Strategy):
    def __init__(self):
        super(ultimate_oscillator_strategy, self).__init__()
        self._buy_threshold = self.Param("BuyThreshold", 30) \
    ...
    def OnReseted(self):
        super(ultimate_oscillator_strategy, self).OnReseted()
        self._prev_rsi = 0.0
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._cooldown = 0
    ...
    def OnStarted2(self, time):
        super(ultimate_oscillator_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return ultimate_oscillator_strategy()
