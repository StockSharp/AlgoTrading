...
class ce_xau_usdt_strategy(Strategy):
    """
    CE_XAU_USDT strategy using EMA crossover for trend timing.
    Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(ce_xau_usdt_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(ce_xau_usdt_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0

    def OnStarted2(self, time):
        super(ce_xau_usdt_strategy, self).OnStarted2(time)
