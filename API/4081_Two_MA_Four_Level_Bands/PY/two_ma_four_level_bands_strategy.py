...
from StockSharp.Algo.Indicators import AverageTrueRange, ExponentialMovingAverage, SimpleMovingAverage
...
class two_ma_four_level_bands_strategy(Strategy):
    ...
    def OnStarted(self, time):
        super(two_ma_four_level_bands_strategy, self).OnStarted(time)
