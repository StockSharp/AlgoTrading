...
class dual_momentum_strategy(Strategy):
    """
    Dual Momentum strategy using EMA crossover.
    Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(dual_momentum_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(dual_momentum_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0
    def OnStarted2(self, time):
        super(dual_momentum_strategy, self).OnStarted2(time)
