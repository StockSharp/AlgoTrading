...
class trax_detrended_price_strategy(Strategy):
    def __init__(self):
        super(trax_detrended_price_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(trax_detrended_price_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return trax_detrended_price_strategy()
