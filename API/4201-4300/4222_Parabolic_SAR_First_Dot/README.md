...
- The conversion uses StockSharp's high-level API (`SubscribeCandles`, `Bind`, `BuyMarket`, `SellMarket`) as required by the project guidelines. Implementations are available in both C# and Python.
