...
class robot_adx_two_ma_strategy(Strategy):
    def __init__(self):
        super(robot_adx_two_ma_strategy, self).__init__()

        self._candle_type = self.Param("CandleType", DataType.TimeFrame(TimeSpan.FromHours(1))) \
            .SetDisplay("Candle Type", "Timeframe.", "General")
        self._fast_ema_length = self.Param("FastEmaLength", 5) \
            .SetDisplay("Fast EMA Length", "Fast EMA period.", "Indicators")
        self._slow_ema_length = self.Param("SlowEmaLength", 12) \
    ...
    def OnStarted2(self, time):
        super(robot_adx_two_ma_strategy, self).OnStarted2(time)
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._entry_price = 0.0
    ...
    def OnReseted(self):
        super(robot_adx_two_ma_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._entry_price = 0.0

    def CreateClone(self):
        return robot_adx_two_ma_strategy()
