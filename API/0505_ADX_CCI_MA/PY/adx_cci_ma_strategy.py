...
from StockSharp.Algo.Indicators import CommodityChannelIndex, AverageDirectionalIndex, SimpleMovingAverage
...
class adx_cci_ma_strategy(Strategy):
    ...
    def OnStarted(self, time):
        ...
        subscription.BindEx(adx, cci, ma, self.OnProcess).Start()
    ...
    def OnProcess(self, candle, adx_value, cci_value, ma_value):
        ...
        cci_v = float(cci_value.GetValue[float]())
