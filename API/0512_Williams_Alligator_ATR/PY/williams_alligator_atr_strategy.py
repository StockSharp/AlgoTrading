...
class williams_alligator_atr_strategy(Strategy):
    ...
    def OnStarted(self, time):
        super(williams_alligator_atr_strategy, self).OnStarted(time)
        ...
        subscription.Bind(jaw, lips, atr, self.OnProcess).Start()
    ...
    def OnProcess(self, candle, jaw_val, lips_val, atr_val):
