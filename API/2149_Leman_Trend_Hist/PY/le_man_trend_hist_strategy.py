...
class le_man_trend_hist_strategy(Strategy):
    def __init__(self):
        super(le_man_trend_hist_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(le_man_trend_hist_strategy, self).OnReseted()
        self._value1 = None
        self._value2 = None
        self._value3 = None

    def OnStarted(self, time):
        super(le_man_trend_hist_strategy, self).OnStarted(time)
    ...
    def CreateClone(self):
        return le_man_trend_hist_strategy()
