...
class cme_equity_futures_price_limits_strategy(Strategy):
    def __init__(self):
        super(cme_equity_futures_price_limits_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(cme_equity_futures_price_limits_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0

    def OnStarted2(self, time):
        super(cme_equity_futures_price_limits_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return cme_equity_futures_price_limits_strategy()
