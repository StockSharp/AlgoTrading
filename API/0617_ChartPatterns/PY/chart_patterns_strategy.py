...
class chart_patterns_strategy(Strategy):
    def __init__(self):
        super(chart_patterns_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(chart_patterns_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0

    def OnStarted2(self, time):
        super(chart_patterns_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return chart_patterns_strategy()
