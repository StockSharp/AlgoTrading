...
/// <summary>
/// Micro Trend Breakouts strategy: SMA crossover with momentum.
/// Buys when fast SMA crosses above slow SMA with positive momentum.
/// Sells when fast SMA crosses below slow SMA with negative momentum.
/// </summary>
public class MicroTrendBreakoutsStrategy : Strategy
{
	...
	protected override void OnStarted2(DateTime time)
	{
		...
		subscription
			.Bind(fastSma, slowSma, momentum, ProcessCandle)
			.Start();
