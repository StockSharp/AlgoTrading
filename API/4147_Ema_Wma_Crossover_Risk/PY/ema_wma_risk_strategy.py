...
class ema_wma_risk_strategy(Strategy):
    def __init__(self):
        super(ema_wma_risk_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(ema_wma_risk_strategy, self).OnStarted2(time)
    ...
    def OnReseted(self):
        super(ema_wma_risk_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._entry_price = 0.0

    def CreateClone(self):
        return ema_wma_risk_strategy()
