...
class gc_with_trend_filter_and_sudden_move_profit_taking_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(gc_with_trend_filter_and_sudden_move_profit_taking_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(gc_with_trend_filter_and_sudden_move_profit_taking_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0

    def OnStarted2(self, time):
        super(gc_with_trend_filter_and_sudden_move_profit_taking_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return gc_with_trend_filter_and_sudden_move_profit_taking_strategy()
