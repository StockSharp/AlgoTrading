...
class milestone_trend_strategy(Strategy):
    def __init__(self):
    ...
    def OnReseted(self):
        super(milestone_trend_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._has_prev = False

    def OnStarted2(self, time):
        super(milestone_trend_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return milestone_trend_strategy()
