...
class get_value_from_n_years_ago_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(get_value_from_n_years_ago_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(get_value_from_n_years_ago_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0

    def OnStarted2(self, time):
        super(get_value_from_n_years_ago_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return get_value_from_n_years_ago_strategy()
