# Estrategia de Ruptura de Pendiente MACD
[English](README.md) | [Русский](README_ru.md) | [中文](README_zh.md) | [Deutsch](README_de.md) | [Português](README_pt.md) | [日本語](README_ja.md)

La estrategia de Ruptura de Pendiente MACD rastrea la tasa de cambio del MACD. Una pendiente inusualmente pronunciada sugiere que se está formando una nueva tendencia.
...
Atrae a los traders activos que buscan una exposición temprana a la tendencia. Las posiciones se cierran cuando la pendiente regresa a lecturas normales. `FastEma` predeterminado = 12.
