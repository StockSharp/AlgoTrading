...
class stop_loss_to_break_even_strategy(Strategy):
    def __init__(self):
        super(stop_loss_to_break_even_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(stop_loss_to_break_even_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._has_prev = False

    def OnStarted2(self, time):
        super(stop_loss_to_break_even_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return stop_loss_to_break_even_strategy()
