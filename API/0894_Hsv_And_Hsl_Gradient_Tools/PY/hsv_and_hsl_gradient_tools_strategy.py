...
class hsv_and_hsl_gradient_tools_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(hsv_and_hsl_gradient_tools_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(hsv_and_hsl_gradient_tools_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0

    def OnStarted2(self, time):
        super(hsv_and_hsl_gradient_tools_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return hsv_and_hsl_gradient_tools_strategy()
