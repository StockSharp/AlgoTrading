...
class ema_cross_macd_session_start_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(ema_cross_macd_session_start_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(ema_cross_macd_session_start_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0
    def OnStarted2(self, time):
        super(ema_cross_macd_session_start_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return ema_cross_macd_session_start_strategy()
