...
public class TwoMAOtherTimeFrameCorrectIntersectionStrategy : Strategy
{
	...
	private readonly StrategyParam<CandlePrices> _fastAppliedPrice;
	private readonly StrategyParam<int> _slowLength;
	private readonly StrategyParam<int> _slowShift;
	private readonly StrategyParam<MovingAverageKinds> _slowMethod;
	private readonly StrategyParam<CandlePrices> _slowAppliedPrice;
	...
	public TwoMAOtherTimeFrameCorrectIntersectionStrategy()
	{
		...
		_fastAppliedPrice = Param(nameof(FastAppliedPrice), CandlePrices.Close)
		...
		_slowAppliedPrice = Param(nameof(SlowAppliedPrice), CandlePrices.Close)
	...
	/// </summary>
	public CandlePrices FastAppliedPrice
	{
	...
	/// </summary>
	public CandlePrices SlowAppliedPrice
	{
