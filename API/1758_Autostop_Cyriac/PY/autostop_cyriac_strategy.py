...
class autostop_cyriac_strategy(Strategy):
    def __init__(self):
        super(autostop_cyriac_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(autostop_cyriac_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._is_initialized = False

    def OnStarted2(self, time):
        super(autostop_cyriac_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return autostop_cyriac_strategy()
