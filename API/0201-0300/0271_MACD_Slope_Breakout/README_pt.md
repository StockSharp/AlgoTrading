# Estratégia de Rompimento de Inclinação MACD
[English](README.md) | [Русский](README_ru.md) | [中文](README_zh.md) | [Español](README_es.md) | [Deutsch](README_de.md) | [日本語](README_ja.md)

A estratégia de Rompimento de Inclinação MACD rastreia a taxa de variação do MACD. Uma inclinação incomumente acentuada sugere que uma nova tendência está se formando.
...
Atrai traders ativos que buscam exposição antecipada à tendência. As posições são encerradas quando a inclinação retorna às leituras normais. `FastEma` padrão = 12.
