...
class gartley_222_strategy(Strategy):
    """
    Gartley222: EMA crossover strategy.
    Buys when fast EMA crosses above slow EMA, sells on reverse.
    """

    def __init__(self):
        super(gartley_222_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(gartley_222_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0

    def OnStarted2(self, time):
        super(gartley_222_strategy, self).OnStarted2(time)
