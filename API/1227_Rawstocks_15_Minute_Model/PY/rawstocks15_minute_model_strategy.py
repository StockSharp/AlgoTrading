...
class rawstocks15_minute_model_strategy(Strategy):
    def __init__(self):
        super(rawstocks15_minute_model_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(rawstocks15_minute_model_strategy, self).OnReseted()
        self._prev_f = 0.0
        self._prev_s = 0.0
        self._init = False
        self._last_signal_ticks = 0
    ...
    def OnStarted(self, time):
        super(rawstocks15_minute_model_strategy, self).OnStarted(time)
    ...
    def CreateClone(self):
        return rawstocks15_minute_model_strategy()
