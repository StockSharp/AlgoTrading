...
class faith_indicator_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(faith_indicator_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(faith_indicator_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0
    def OnStarted2(self, time):
        super(faith_indicator_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return faith_indicator_strategy()
