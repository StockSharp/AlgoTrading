...
class ema_scoring_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(ema_scoring_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(ema_scoring_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0
    def OnStarted2(self, time):
        super(ema_scoring_strategy, self).OnStarted2(time)
