...
class dual_selector_v2_cryptogyani_strategy(Strategy):
    """
    Dual Selector V2 Cryptogyani strategy using EMA crossover.
    Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(dual_selector_v2_cryptogyani_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(dual_selector_v2_cryptogyani_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0
    def OnStarted2(self, time):
        super(dual_selector_v2_cryptogyani_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return dual_selector_v2_cryptogyani_strategy()
