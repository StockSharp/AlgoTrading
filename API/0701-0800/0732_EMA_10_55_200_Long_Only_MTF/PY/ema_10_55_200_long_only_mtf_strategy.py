...
class ema_10_55_200_long_only_mtf_strategy(Strategy):
    def __init__(self):
        super(ema_10_55_200_long_only_mtf_strategy, self).__init__()
        self._fast_ema_period = self.Param("FastEmaPeriod", 130) \
            .SetGreaterThanZero() \
    ...
    def OnReseted(self):
        super(ema_10_55_200_long_only_mtf_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0

    def OnStarted2(self, time):
        super(ema_10_55_200_long_only_mtf_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return ema_10_55_200_long_only_mtf_strategy()
