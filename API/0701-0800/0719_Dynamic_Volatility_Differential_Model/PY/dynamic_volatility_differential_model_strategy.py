...
class dynamic_volatility_differential_model_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(dynamic_volatility_differential_model_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(dynamic_volatility_differential_model_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0
    def OnStarted2(self, time):
        super(dynamic_volatility_differential_model_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return dynamic_volatility_differential_model_strategy()
