...
class ehlers_combo_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(ehlers_combo_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(ehlers_combo_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0
    def OnStarted2(self, time):
        super(ehlers_combo_strategy, self).OnStarted2(time)
