...
class ema_shift_parallel_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(ema_shift_parallel_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(ema_shift_parallel_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0
    def OnStarted2(self, time):
        super(ema_shift_parallel_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return ema_shift_parallel_strategy()
