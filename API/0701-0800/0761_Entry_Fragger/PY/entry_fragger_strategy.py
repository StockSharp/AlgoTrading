...
class entry_fragger_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(entry_fragger_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(entry_fragger_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0
    def OnStarted2(self, time):
        super(entry_fragger_strategy, self).OnStarted2(time)
