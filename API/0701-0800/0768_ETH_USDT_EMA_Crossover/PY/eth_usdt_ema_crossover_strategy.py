...
class eth_usdt_ema_crossover_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(eth_usdt_ema_crossover_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(eth_usdt_ema_crossover_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0
    def OnStarted2(self, time):
        super(eth_usdt_ema_crossover_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return eth_usdt_ema_crossover_strategy()
