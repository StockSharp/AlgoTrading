...
class external_signals_tester_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(external_signals_tester_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(external_signals_tester_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0
    def OnStarted2(self, time):
        super(external_signals_tester_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return external_signals_tester_strategy()
