...
class good_mode_rsi_v2_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(good_mode_rsi_v2_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(good_mode_rsi_v2_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0

    def OnStarted2(self, time):
        super(good_mode_rsi_v2_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return good_mode_rsi_v2_strategy()
