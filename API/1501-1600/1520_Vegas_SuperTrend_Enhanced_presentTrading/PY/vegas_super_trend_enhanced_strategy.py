...
class vegas_super_trend_enhanced_strategy(Strategy):
    def __init__(self):
        super(vegas_super_trend_enhanced_strategy, self).__init__()
    ...
    @property
    def vegas_window(self):
        return self._vegas_window.Value

    @property
    def super_trend_multiplier(self):
        return self._super_trend_multiplier.Value

    def OnReseted(self):
        super(vegas_super_trend_enhanced_strategy, self).OnReseted()
        self._prev_rsi = 0.0
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._cooldown = 0
    ...
    def OnStarted2(self, time):
        super(vegas_super_trend_enhanced_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return vegas_super_trend_enhanced_strategy()
