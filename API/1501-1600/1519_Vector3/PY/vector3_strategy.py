...
class vector3_strategy(Strategy):
    def __init__(self):
        super(vector3_strategy, self).__init__()
        self._fast_length = self.Param("FastLength", 5) \
            .SetDisplay("Fast Length", "Fast MA period", "General")
        self._middle_length = self.Param("MiddleLength", 13) \
    ...
    def middle_length(self):
        return self._middle_length.Value
    ...
    def OnReseted(self):
        super(vector3_strategy, self).OnReseted()
        self._prev_rsi = 0.0
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._cooldown = 0
    ...
    def OnStarted2(self, time):
        super(vector3_strategy, self).OnStarted2(time)
