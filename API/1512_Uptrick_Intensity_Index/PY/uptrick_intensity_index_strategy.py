...
class uptrick_intensity_index_strategy(Strategy):
    def __init__(self):
        super(uptrick_intensity_index_strategy, self).__init__()
        ...
        self._ma3_length = self.Param("Ma3Length", 50) \
            .SetDisplay("MA3 Length", "Length of third SMA", "General")
        self._tii_smooth = self.Param("TiiSmooth", TimeSpan.FromMinutes(5)) \
    ...
    @property
    def ma3_length(self):
        return self._ma3_length.Value

    @property
    def tii_smooth(self):
        return self._tii_smooth.Value
    ...
    def OnReseted(self):
        super(uptrick_intensity_index_strategy, self).OnReseted()
        self._prev_rsi = 0.0
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._cooldown = 0
    ...
    def OnStarted2(self, time):
        super(uptrick_intensity_index_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return uptrick_intensity_index_strategy()
