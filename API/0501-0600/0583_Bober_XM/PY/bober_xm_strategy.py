...
class bober_xm_strategy(Strategy):
    def __init__(self):
        super(bober_xm_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(bober_xm_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0

    def OnStarted2(self, time):
        super(bober_xm_strategy, self).OnStarted2(time)
