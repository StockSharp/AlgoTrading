...
class buying_selling_volume_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(buying_selling_volume_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(buying_selling_volume_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0

    def OnStarted2(self, time):
        super(buying_selling_volume_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return buying_selling_volume_strategy()
