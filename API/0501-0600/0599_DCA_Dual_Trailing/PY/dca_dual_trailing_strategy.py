...
class dca_dual_trailing_strategy(Strategy):
    def __init__(self):
        super(dca_dual_trailing_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(dca_dual_trailing_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0

    def OnStarted2(self, time):
        super(dca_dual_trailing_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return dca_dual_trailing_strategy()
