...
class bar_balance_strategy(Strategy):
    def __init__(self):
        super(bar_balance_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(bar_balance_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._bar_index = 0
        self._last_trade_bar = 0
    ...
    def OnStarted2(self, time):
        super(bar_balance_strategy, self).OnStarted2(time)
