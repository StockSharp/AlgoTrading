...
class consecutive_bars_above_below_ema_buy_the_dip_strategy(Strategy):
    def __init__(self):
        super(consecutive_bars_above_below_ema_buy_the_dip_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(consecutive_bars_above_below_ema_buy_the_dip_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0

    def OnStarted2(self, time):
        super(consecutive_bars_above_below_ema_buy_the_dip_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return consecutive_bars_above_below_ema_buy_the_dip_strategy()
