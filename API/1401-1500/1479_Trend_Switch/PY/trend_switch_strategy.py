...
class trend_switch_strategy(Strategy):
    def __init__(self):
        super(trend_switch_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(trend_switch_strategy, self).OnStarted2(time)
