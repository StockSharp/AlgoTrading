...
class turn_around_tuesday_on_steroids_strategy(Strategy):
    def __init__(self):
    ...
    def OnReseted(self):
        super(turn_around_tuesday_on_steroids_strategy, self).OnReseted()
        self._prev_rsi = 0.0
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._cooldown = 0
    ...
    def OnStarted2(self, time):
        super(turn_around_tuesday_on_steroids_strategy, self).OnStarted2(time)
        rsi = RelativeStrengthIndex()
        rsi.Length = self.ma_period
    ...
    def CreateClone(self):
        return turn_around_tuesday_on_steroids_strategy()
