...
class trend_confirmation_strategy(Strategy):
    def __init__(self):
        super(trend_confirmation_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(trend_confirmation_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return trend_confirmation_strategy()
