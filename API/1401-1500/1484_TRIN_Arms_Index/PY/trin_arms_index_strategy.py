...
class trin_arms_index_strategy(Strategy):
    def __init__(self):
        super(trin_arms_index_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(trin_arms_index_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return trin_arms_index_strategy()
