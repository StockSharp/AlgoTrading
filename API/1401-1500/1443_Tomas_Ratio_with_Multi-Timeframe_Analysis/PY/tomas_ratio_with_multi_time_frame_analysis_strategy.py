...
class tomas_ratio_with_multi_time_frame_analysis_strategy(Strategy):
    def __init__(self):
        super(tomas_ratio_with_multi_time_frame_analysis_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(tomas_ratio_with_multi_time_frame_analysis_strategy, self).OnReseted()
        self._prev_f = 0.0
        self._prev_s = 0.0
        self._init = False
        self._last_signal_ticks = 0
    ...
    def OnStarted2(self, time):
        super(tomas_ratio_with_multi_time_frame_analysis_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return tomas_ratio_with_multi_time_frame_analysis_strategy()
