...
class trend_vanguard_strategy(Strategy):
    def __init__(self):
        super(trend_vanguard_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(trend_vanguard_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return trend_vanguard_strategy()
