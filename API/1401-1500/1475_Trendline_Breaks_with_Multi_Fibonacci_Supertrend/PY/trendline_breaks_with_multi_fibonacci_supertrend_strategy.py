...
class trendline_breaks_with_multi_fibonacci_supertrend_strategy(Strategy):
    def __init__(self):
        super(trendline_breaks_with_multi_fibonacci_supertrend_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(trendline_breaks_with_multi_fibonacci_supertrend_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return trendline_breaks_with_multi_fibonacci_supertrend_strategy()
