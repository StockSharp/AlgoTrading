...
class trend_following_mas3_d_strategy(Strategy):
    def __init__(self):
        super(trend_following_mas3_d_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(trend_following_mas3_d_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return trend_following_mas3_d_strategy()
