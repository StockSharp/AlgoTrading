...
class trend_type_indicator_strategy(Strategy):
    def __init__(self):
        super(trend_type_indicator_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(trend_type_indicator_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return trend_type_indicator_strategy()
