...
class trend_sync_pro_smc_strategy(Strategy):
    def __init__(self):
        super(trend_sync_pro_smc_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(trend_sync_pro_smc_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return trend_sync_pro_smc_strategy()
