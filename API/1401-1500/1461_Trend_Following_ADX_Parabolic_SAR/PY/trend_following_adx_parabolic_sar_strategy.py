...
class trend_following_adx_parabolic_sar_strategy(Strategy):
    def __init__(self):
    ...
    def OnStarted2(self, time):
        super(trend_following_adx_parabolic_sar_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return trend_following_adx_parabolic_sar_strategy()
