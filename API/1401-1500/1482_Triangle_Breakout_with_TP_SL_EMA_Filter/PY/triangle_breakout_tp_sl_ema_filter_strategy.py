...
class triangle_breakout_tp_sl_ema_filter_strategy(Strategy):
    def __init__(self):
        super(triangle_breakout_tp_sl_ema_filter_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(triangle_breakout_tp_sl_ema_filter_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return triangle_breakout_tp_sl_ema_filter_strategy()
