...
class commitment_of_trader_r_strategy(Strategy):
    def __init__(self):
        super(commitment_of_trader_r_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(commitment_of_trader_r_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0

    def OnStarted2(self, time):
        super(commitment_of_trader_r_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return commitment_of_trader_r_strategy()
