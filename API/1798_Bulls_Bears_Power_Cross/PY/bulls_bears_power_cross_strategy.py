...
class bulls_bears_power_cross_strategy(Strategy):
    def __init__(self):
        super(bulls_bears_power_cross_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(bulls_bears_power_cross_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._has_prev = False

    def OnStarted2(self, time):
        super(bulls_bears_power_cross_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return bulls_bears_power_cross_strategy()
