...
* The conversion focuses on the high-level StockSharp API: indicator binding, candle subscriptions, and helper methods (`BuyStop`, `SellStop`, `SellMarket`, etc.). Implementations are available in both C# and Python.
