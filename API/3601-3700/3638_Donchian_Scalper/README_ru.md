...
* Перенос выполнен на высокоуровневом API StockSharp: используется подписка на свечи, привязка индикаторов и готовые методы `BuyStop`/`SellStop`/`SellMarket`. Реализации доступны на C# и Python.
