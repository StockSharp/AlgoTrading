...
Die C#- und Python-Implementierungen portieren die ursprüngliche Logik auf die StockSharp-Hochebene API und ersetzen die Tick-Verarbeitung durch fertige Kerzen, um ein stabiles plattformübergreifendes Verhalten sicherzustellen. Bei jedem Kerzenschluss wird das binäre Preismuster aktualisiert, das Hopfield-Netzwerk neu trainiert, die historische Genauigkeit bewertet und eine Online-Prognose für die bevorstehenden Schritte erstellt.
