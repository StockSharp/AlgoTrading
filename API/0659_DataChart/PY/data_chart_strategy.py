...
class data_chart_strategy(Strategy):
    """
    DataChart strategy using EMA crossover.
    Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(data_chart_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(data_chart_strategy, self).OnStarted2(time)
