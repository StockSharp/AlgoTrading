...
/// <summary>
/// Awesome Oscillator Trader: SMA 5/34 crossover (AO concept).
...
public class AwesomeOscTraderStrategy : Strategy
{
	...
	public AwesomeOscTraderStrategy()
	{
		...
		_fastPeriod = Param(nameof(FastPeriod), 5)
			.SetGreaterThanZero()
			.SetDisplay("Fast SMA", "Fast SMA period (like AO short)", "Indicators");

		_slowPeriod = Param(nameof(SlowPeriod), 20)
			.SetGreaterThanZero()
			.SetDisplay("Slow SMA", "Slow SMA period (like AO long)", "Indicators");
	}
