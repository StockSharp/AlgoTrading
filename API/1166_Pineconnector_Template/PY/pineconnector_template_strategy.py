...
class pineconnector_template_strategy(Strategy):
    def __init__(self):
        super(pineconnector_template_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(pineconnector_template_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._initialized = False
        self._last_signal_ticks = 0
    ...
    def OnStarted2(self, time):
        super(pineconnector_template_strategy, self).OnStarted2(time)
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._initialized = False
        self._last_signal_ticks = 0
    ...
    def CreateClone(self):
        return pineconnector_template_strategy()
