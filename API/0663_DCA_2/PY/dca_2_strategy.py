...
class dca_2_strategy(Strategy):
    """
    DCA 2 strategy using EMA crossover.
    Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(dca_2_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(dca_2_strategy, self).OnStarted2(time)
