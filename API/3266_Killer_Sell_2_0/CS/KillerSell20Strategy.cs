...
public class KillerSell20Strategy : Strategy
{
	...
	private WilliamsR _wprEntry = null!;
	private WilliamsR _wprExit = null!;
	...
	protected override void OnStarted(DateTimeOffset time)
	{
		...
		_wprEntry = new WilliamsR { Length = EntryWprPeriod };
		_wprExit = new WilliamsR { Length = ExitWprPeriod };
