...
class stoch_tp_ts_v3103_strategy(Strategy):
    def __init__(self):
        super(stoch_tp_ts_v3103_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(stoch_tp_ts_v3103_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._has_prev = False

    def OnStarted2(self, time):
        super(stoch_tp_ts_v3103_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return stoch_tp_ts_v3103_strategy()
