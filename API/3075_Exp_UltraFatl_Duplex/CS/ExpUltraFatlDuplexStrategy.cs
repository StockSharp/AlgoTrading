...
/// <summary>Applied price modes supported by the UltraFATL indicator.</summary>
public enum AppliedPrice
{
	...
	Low,
	/// <summary>Median price (HL/2).</summary>
	Median,
	/// <summary>Typical price (HLC/3).</summary>
	Typical,
	/// <summary>Weighted close price (HLCC/4).</summary>
	Weighted,
	/// <summary>Simple price ((Open + Close)/2).</summary>
	Simplified,
	/// <summary>Quarter price ((Open + High + Low + Close)/4).</summary>
	Quarter,
	/// <summary>Trend-following price based on candle direction.</summary>
	TrendFollow0,
	/// <summary>Alternative trend-following price.</summary>
	TrendFollow1,
	/// <summary>DeMark price.</summary>
	DeMark
}

/// <summary>Available smoothing methods for the UltraFATL ladder.</summary>
public enum UltraSmoothMethod
{
	...
	Jurik,
	/// <summary>Jurik (JurX) moving average.</summary>
	JurX,
	/// <summary>Parabolic moving average approximation.</summary>
	Parabolic,
	/// <summary>Tillson T3 approximation.</summary>
	T3,
	/// <summary>VIDYA adaptive moving average.</summary>
	Vidya,
