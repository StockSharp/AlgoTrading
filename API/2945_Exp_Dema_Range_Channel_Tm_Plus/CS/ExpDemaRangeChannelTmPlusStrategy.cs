...
public class ExpDemaRangeChannelTmPlusStrategy : Strategy
{
	...
	protected override void OnStarted(DateTimeOffset time)
	{
		...
		Unit stopLossUnit = StopLossPoints > 0m ? new Unit(StopLossPoints * step, UnitTypes.Absolute) : (Unit)null;
		Unit takeProfitUnit = TakeProfitPoints > 0m ? new Unit(TakeProfitPoints * step, UnitTypes.Absolute) : (Unit)null;
