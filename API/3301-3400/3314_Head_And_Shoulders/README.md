...
- StockSharp documentation on [high-level strategies](https://doc.stocksharp.com/en/topics/strategy/highlevel.html) and [indicator binding](https://doc.stocksharp.com/en/topics/strategy/highlevel/bind.html).
