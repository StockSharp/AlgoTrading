...
/// </summary>
public class QuantitativeTrendUptrendLongStrategy : Strategy
{
	...
	/// <summary>
	/// Initializes a new instance of <see cref="QuantitativeTrendUptrendLongStrategy"/>.
	/// </summary>
	public QuantitativeTrendUptrendLongStrategy()
	{
