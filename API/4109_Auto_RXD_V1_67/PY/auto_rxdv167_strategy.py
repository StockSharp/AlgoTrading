...
from StockSharp.Algo.Indicators import AverageTrueRange, CommodityChannelIndex, ExponentialMovingAverage, RelativeStrengthIndex
...
class auto_rxdv167_strategy(Strategy):
    ...
    def OnStarted(self, time):
        super(auto_rxdv167_strategy, self).OnStarted(time)
        ...
        subscription.Bind(self._rsi, self._cci, self._ema, self._atr, self._process_candle).Start()
