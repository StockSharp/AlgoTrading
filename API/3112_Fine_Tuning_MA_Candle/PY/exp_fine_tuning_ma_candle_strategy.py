...
class exp_fine_tuning_ma_candle_strategy(Strategy):
    def __init__(self):
        super(exp_fine_tuning_ma_candle_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(exp_fine_tuning_ma_candle_strategy, self).OnReseted()
        self._fast = None
        self._slow = None
        self._ema = None
        self._prev_fast = 0.0
    ...
    def OnStarted2(self, time):
        super(exp_fine_tuning_ma_candle_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return exp_fine_tuning_ma_candle_strategy()
