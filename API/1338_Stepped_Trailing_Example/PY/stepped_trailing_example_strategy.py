...
class stepped_trailing_example_strategy(Strategy):
    def __init__(self):
        super(stepped_trailing_example_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(stepped_trailing_example_strategy, self).OnReseted()
        self._prev_f = 0.0
        self._prev_s = 0.0
        self._init = False
        self._last_signal_ticks = 0
    ...
    def OnStarted2(self, time):
        super(stepped_trailing_example_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return stepped_trailing_example_strategy()
