...
class dskyz_dafe_genesis_strategy(Strategy):
    """
    Dskyz DAFE Genesis strategy using EMA crossover.
    Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(dskyz_dafe_genesis_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(dskyz_dafe_genesis_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0
    def OnStarted2(self, time):
        super(dskyz_dafe_genesis_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return dskyz_dafe_genesis_strategy()
