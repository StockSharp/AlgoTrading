...
class refined_sma_ema_crossover_with_ichimoku_and200_sma_filter_strategy(Strategy):
    def __init__(self):
        super(refined_sma_ema_crossover_with_ichimoku_and200_sma_filter_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(refined_sma_ema_crossover_with_ichimoku_and200_sma_filter_strategy, self).OnReseted()
        self._prev_f = 0.0
        self._prev_s = 0.0
        self._init = False
        self._last_signal = DateTimeOffset.MinValue
    ...
    def OnStarted(self, time):
        super(refined_sma_ema_crossover_with_ichimoku_and200_sma_filter_strategy, self).OnStarted(time)
    ...
    def CreateClone(self):
        return refined_sma_ema_crossover_with_ichimoku_and200_sma_filter_strategy()
