...
class us_index_first30m_candle_strategy(Strategy):
    def __init__(self):
    ...
    def OnReseted(self):
        super(us_index_first30m_candle_strategy, self).OnReseted()
        self._prev_rsi = 0.0
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._cooldown = 0
    ...
    def OnStarted2(self, time):
        super(us_index_first30m_candle_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return us_index_first30m_candle_strategy()
