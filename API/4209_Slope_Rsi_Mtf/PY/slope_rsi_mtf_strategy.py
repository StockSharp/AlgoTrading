...
class slope_rsi_mtf_strategy(Strategy):
    def __init__(self):
        super(slope_rsi_mtf_strategy, self).__init__()
    ...
    def OnStarted2(self, time):
        super(slope_rsi_mtf_strategy, self).OnStarted2(time)
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._entry_price = 0.0
    ...
    def OnReseted(self):
        super(slope_rsi_mtf_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._entry_price = 0.0

    def CreateClone(self):
        return slope_rsi_mtf_strategy()
