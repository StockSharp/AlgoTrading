...
class express_generator_strategy(Strategy):
    """
    ...
    def __init__(self):
        super(express_generator_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(express_generator_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0
    def OnStarted2(self, time):
        super(express_generator_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return express_generator_strategy()
