...
class short_term_reversal_futures_strategy(Strategy):
    ...
    def __init__(self):
        super(short_term_reversal_futures_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(short_term_reversal_futures_strategy, self).OnReseted()
        self._benchmark = None
        self._primary_return = None
        self._benchmark_return = None
        self._spread_average = None
    ...
    def OnStarted2(self, time):
        super(short_term_reversal_futures_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return short_term_reversal_futures_strategy()
