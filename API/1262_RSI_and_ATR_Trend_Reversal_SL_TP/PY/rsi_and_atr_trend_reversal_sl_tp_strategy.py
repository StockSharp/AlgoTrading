...
class rsi_and_atr_trend_reversal_sl_tp_strategy(Strategy):
    def __init__(self):
        super(rsi_and_atr_trend_reversal_sl_tp_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(rsi_and_atr_trend_reversal_sl_tp_strategy, self).OnReseted()
        self._prev_f = 0.0
        self._prev_s = 0.0
        self._init = False
        self._last_signal = DateTimeOffset.MinValue
    ...
    def CreateClone(self):
        return rsi_and_atr_trend_reversal_sl_tp_strategy()
