...
/// </summary>
public class CoupleHedgeBasketStrategy : Strategy
{
	...
	/// <summary>
	/// Initializes a new instance of <see cref="CoupleHedgeBasketStrategy"/>.
	/// </summary>
	...
	private sealed class GroupSlot
	{
		...
		public GroupSlot(CoupleHedgeBasketStrategy owner, int index, string plusId, string minusId)
		{
			Index = index;
