...
class dskyz_adaptive_futures_elite_strategy(Strategy):
    """
    Dskyz Adaptive Futures Elite strategy using EMA crossover.
    Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(dskyz_adaptive_futures_elite_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(dskyz_adaptive_futures_elite_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0
    def OnStarted2(self, time):
        super(dskyz_adaptive_futures_elite_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return dskyz_adaptive_futures_elite_strategy()
