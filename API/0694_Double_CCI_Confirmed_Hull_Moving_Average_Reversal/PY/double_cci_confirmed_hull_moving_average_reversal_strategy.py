...
class double_cci_confirmed_hull_moving_average_reversal_strategy(Strategy):
    """
    Double CCI Confirmed Hull Moving Average Reversal strategy using EMA crossover.
    ...
    def OnStarted(self, time):
        super(double_cci_confirmed_hull_moving_average_reversal_strategy, self).OnStarted(time)
