# Volumen Steigungs-Ausbruch-Strategie
[English](README.md) | [Русский](README_ru.md) | [中文](README_zh.md) | [Español](README_es.md) | [Português](README_pt.md) | [日本語](README_ja.md)

Die Volumen Steigungs-Ausbruch-Strategie verfolgt die Änderungsrate des Volumens. Eine ungewöhnlich steile Steigung deutet darauf hin, dass sich ein neuer Trend bildet.
...
Sie spricht aktive Trader an, die eine frühzeitige Trendexposition anstreben. Positionen werden geschlossen, wenn die Steigung wieder in den Normalbereich zurückfällt. Standard `VolumeSMAPeriod` = 20.
