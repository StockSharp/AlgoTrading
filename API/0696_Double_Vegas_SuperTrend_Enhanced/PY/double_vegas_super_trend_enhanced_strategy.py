...
class double_vegas_super_trend_enhanced_strategy(Strategy):
    """
    Double Vegas SuperTrend Enhanced strategy using EMA crossover.
    Enters long on golden cross, short on death cross.
    """

    def __init__(self):
        super(double_vegas_super_trend_enhanced_strategy, self).__init__()
    ...
    def OnReseted(self):
        super(double_vegas_super_trend_enhanced_strategy, self).OnReseted()
        self._prev_fast_ema = 0.0
        self._prev_slow_ema = 0.0
    def OnStarted2(self, time):
        super(double_vegas_super_trend_enhanced_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return double_vegas_super_trend_enhanced_strategy()
