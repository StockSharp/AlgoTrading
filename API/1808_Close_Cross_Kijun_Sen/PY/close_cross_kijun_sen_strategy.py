...
class close_cross_kijun_sen_strategy(Strategy):
    def __init__(self):
        super(close_cross_kijun_sen_strategy, self).__init__()
        self._fast_period = self.Param("FastPeriod", 12)             .SetDisplay("Fast Period", "Fast EMA period", "Indicators")
        self._slow_period = self.Param("SlowPeriod", 50)             .SetDisplay("Slow Period", "Slow EMA period", "Parameters")
    ...
    def OnReseted(self):
        super(close_cross_kijun_sen_strategy, self).OnReseted()
        self._prev_fast = 0.0
        self._prev_slow = 0.0
        self._has_prev = False

    def OnStarted2(self, time):
        super(close_cross_kijun_sen_strategy, self).OnStarted2(time)
    ...
    def CreateClone(self):
        return close_cross_kijun_sen_strategy()
